...
type InlineObject23 struct {
	Response *InlineObject23Response `json:"response,omitempty"`
}
...
func (o *InlineObject23) GetResponse() InlineObject23Response {
	if o == nil || IsNil(o.Response) {
		var ret InlineObject23Response
		return ret
	}
	return *o.Response
}
...
func (o *InlineObject23) GetResponseOk() (*InlineObject23Response, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject23) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given InlineObject23Response and assigns it to the Response field.
func (o *InlineObject23) SetResponse(v InlineObject23Response) {
	o.Response = &v
}
