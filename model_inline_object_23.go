...
func (o *InlineObject23) GetMessage() string {
...
func (o *InlineObject23) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject23) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject23) SetMessage(v string) {
	o.Message = &v
}
