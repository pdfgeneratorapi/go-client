...
// checks if the FormConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormConfiguration{}

// FormConfiguration Optional display configuration shown around the form fields in the embeddable Form Builder and in the shared data collection form.
type FormConfiguration struct {
	...
	Intro NullableString `json:"intro,omitempty"`
	// Closing text displayed below the form fields. Supports rich text.
	Outro NullableString `json:"outro,omitempty"`
}
...
func (o *FormConfiguration) SetTitleNil() {
	o.Title.Set(nil)
}
...
// GetIntro returns the Intro field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FormConfiguration) GetIntro() string {
	if o == nil || IsNil(o.Intro.Get()) {
		var ret string
		return ret
	}
	return *o.Intro.Get()
...
// SetIntro gets a reference to the given NullableString and assigns it to the Intro field.
func (o *FormConfiguration) SetIntro(v string) {
	o.Intro.Set(&v)
}
// SetIntroNil sets the value for Intro to be an explicit nil
func (o *FormConfiguration) SetIntroNil() {
	o.Intro.Set(nil)
}
...
// GetOutro returns the Outro field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FormConfiguration) GetOutro() string {
	if o == nil || IsNil(o.Outro.Get()) {
		var ret string
		return ret
	}
	return *o.Outro.Get()
...
// SetOutro gets a reference to the given NullableString and assigns it to the Outro field.
func (o *FormConfiguration) SetOutro(v string) {
	o.Outro.Set(&v)
}
// SetOutroNil sets the value for Outro to be an explicit nil
func (o *FormConfiguration) SetOutroNil() {
	o.Outro.Set(nil)
}
...
func (o FormConfiguration) MarshalJSON() ([]byte, error) {
...
func (o FormConfiguration) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.Title.IsSet() {
		toSerialize["title"] = o.Title.Get()
	}
	if o.Intro.IsSet() {
		toSerialize["intro"] = o.Intro.Get()
	}
	if o.Outro.IsSet() {
		toSerialize["outro"] = o.Outro.Get()
	}
	return toSerialize, nil
}

type NullableFormConfiguration struct {
	value *FormConfiguration
	isSet bool
}

func (v NullableFormConfiguration) Get() *FormConfiguration {
	return v.value
}

func (v *NullableFormConfiguration) Set(val *FormConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableFormConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableFormConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormConfiguration(val *FormConfiguration) *NullableFormConfiguration {
	return &NullableFormConfiguration{value: val, isSet: true}
}

func (v NullableFormConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
