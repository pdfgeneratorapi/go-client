...
// checks if the TemplateDefinitionNewDataSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDefinitionNewDataSettings{}

// TemplateDefinitionNewDataSettings Defines filter and sort option for root data set.
type TemplateDefinitionNewDataSettings struct {
...
// NewTemplateDefinitionNewDataSettings instantiates a new TemplateDefinitionNewDataSettings object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateDefinitionNewDataSettings() *TemplateDefinitionNewDataSettings {
	this := TemplateDefinitionNewDataSettings{}
	return &this
}

// NewTemplateDefinitionNewDataSettingsWithDefaults instantiates a new TemplateDefinitionNewDataSettings object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateDefinitionNewDataSettingsWithDefaults() *TemplateDefinitionNewDataSettings {
	this := TemplateDefinitionNewDataSettings{}
	return &this
}

// GetSortBy returns the SortBy field value if set, zero value otherwise.
func (o *TemplateDefinitionNewDataSettings) GetSortBy() []map[string]interface{} {
...
func (o *TemplateDefinitionNewDataSettings) GetSortByOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.SortBy) {
		return nil, false
	}
...
func (o *TemplateDefinitionNewDataSettings) HasSortBy() bool {
	if o != nil && !IsNil(o.SortBy) {
		return true
	}
...
// SetSortBy gets a reference to the given []map[string]interface{} and assigns it to the SortBy field.
func (o *TemplateDefinitionNewDataSettings) SetSortBy(v []map[string]interface{}) {
	o.SortBy = v
}

// GetFilterBy returns the FilterBy field value if set, zero value otherwise.
func (o *TemplateDefinitionNewDataSettings) GetFilterBy() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionNewDataSettings) GetFilterByOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.FilterBy) {
		return nil, false
	}
...
func (o *TemplateDefinitionNewDataSettings) HasFilterBy() bool {
	if o != nil && !IsNil(o.FilterBy) {
		return true
	}
...
// SetFilterBy gets a reference to the given []map[string]interface{} and assigns it to the FilterBy field.
func (o *TemplateDefinitionNewDataSettings) SetFilterBy(v []map[string]interface{}) {
	o.FilterBy = v
}

// GetTransform returns the Transform field value if set, zero value otherwise.
func (o *TemplateDefinitionNewDataSettings) GetTransform() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionNewDataSettings) GetTransformOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Transform) {
		return nil, false
	}
...
func (o *TemplateDefinitionNewDataSettings) HasTransform() bool {
	if o != nil && !IsNil(o.Transform) {
		return true
	}
...
func (o *TemplateDefinitionNewDataSettings) SetTransform(v []map[string]interface{}) {
	o.Transform = v
}

func (o TemplateDefinitionNewDataSettings) MarshalJSON() ([]byte, error) {
...
func (o TemplateDefinitionNewDataSettings) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateDefinitionNewDataSettings struct {
	value *TemplateDefinitionNewDataSettings
	isSet bool
}

func (v NullableTemplateDefinitionNewDataSettings) Get() *TemplateDefinitionNewDataSettings {
	return v.value
}

func (v *NullableTemplateDefinitionNewDataSettings) Set(val *TemplateDefinitionNewDataSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDefinitionNewDataSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDefinitionNewDataSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDefinitionNewDataSettings(val *TemplateDefinitionNewDataSettings) *NullableTemplateDefinitionNewDataSettings {
	return &NullableTemplateDefinitionNewDataSettings{value: val, isSet: true}
}

func (v NullableTemplateDefinitionNewDataSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDefinitionNewDataSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
