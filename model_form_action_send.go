...
// checks if the FormActionSend type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormActionSend{}

// FormActionSend Sends the generated document via HTTP POST request to the specified URL.
type FormActionSend struct {
	SendDocument *FormActionSendSendDocument `json:"send_document,omitempty"`
}

// NewFormActionSend instantiates a new FormActionSend object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFormActionSend() *FormActionSend {
	this := FormActionSend{}
	return &this
}

// NewFormActionSendWithDefaults instantiates a new FormActionSend object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFormActionSendWithDefaults() *FormActionSend {
	this := FormActionSend{}
	return &this
}

// GetSendDocument returns the SendDocument field value if set, zero value otherwise.
func (o *FormActionSend) GetSendDocument() FormActionSendSendDocument {
	if o == nil || IsNil(o.SendDocument) {
		var ret FormActionSendSendDocument
		return ret
	}
	return *o.SendDocument
}

// GetSendDocumentOk returns a tuple with the SendDocument field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FormActionSend) GetSendDocumentOk() (*FormActionSendSendDocument, bool) {
	if o == nil || IsNil(o.SendDocument) {
		return nil, false
	}
	return o.SendDocument, true
}

// HasSendDocument returns a boolean if a field has been set.
func (o *FormActionSend) HasSendDocument() bool {
	if o != nil && !IsNil(o.SendDocument) {
		return true
	}
...
// SetSendDocument gets a reference to the given FormActionSendSendDocument and assigns it to the SendDocument field.
func (o *FormActionSend) SetSendDocument(v FormActionSendSendDocument) {
	o.SendDocument = &v
}

func (o FormActionSend) MarshalJSON() ([]byte, error) {
...
func (o FormActionSend) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SendDocument) {
		toSerialize["send_document"] = o.SendDocument
	}
	return toSerialize, nil
}

type NullableFormActionSend struct {
	value *FormActionSend
	isSet bool
}

func (v NullableFormActionSend) Get() *FormActionSend {
	return v.value
}

func (v *NullableFormActionSend) Set(val *FormActionSend) {
	v.value = val
	v.isSet = true
}

func (v NullableFormActionSend) IsSet() bool {
	return v.isSet
}

func (v *NullableFormActionSend) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormActionSend(val *FormActionSend) *NullableFormActionSend {
	return &NullableFormActionSend{value: val, isSet: true}
}

func (v NullableFormActionSend) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormActionSend) UnmarshalJSON(src []byte) error {
	v.isSet = true
