...
// APIClient manages communication with the PDF Generator API API v4.0.28
...
type APIClient struct {
	...
	EInvoicesAPI *EInvoicesAPIService
	...
	TemplateLibraryAPI *TemplateLibraryAPIService
