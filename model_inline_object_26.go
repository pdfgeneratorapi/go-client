...
func (o *InlineObject26) GetMessage() string {
...
func (o *InlineObject26) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject26) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject26) SetMessage(v string) {
	o.Message = &v
}
