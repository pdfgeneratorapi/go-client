...
// WatermarkImage struct for WatermarkImage
type WatermarkImage struct {
	WatermarkImageContentBase64 *WatermarkImageContentBase64
	WatermarkImageContentUrl *WatermarkImageContentUrl
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *WatermarkImage) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into WatermarkImageContentBase64
	err = json.Unmarshal(data, &dst.WatermarkImageContentBase64);
	if err == nil {
		jsonWatermarkImageContentBase64, _ := json.Marshal(dst.WatermarkImageContentBase64)
		if string(jsonWatermarkImageContentBase64) == "{}" { // empty struct
			dst.WatermarkImageContentBase64 = nil
		} else {
			return nil // data stored in dst.WatermarkImageContentBase64, return on the first match
		}
	} else {
		dst.WatermarkImageContentBase64 = nil
	}

	// try to unmarshal JSON data into WatermarkImageContentUrl
	err = json.Unmarshal(data, &dst.WatermarkImageContentUrl);
	if err == nil {
		jsonWatermarkImageContentUrl, _ := json.Marshal(dst.WatermarkImageContentUrl)
		if string(jsonWatermarkImageContentUrl) == "{}" { // empty struct
			dst.WatermarkImageContentUrl = nil
		} else {
			return nil // data stored in dst.WatermarkImageContentUrl, return on the first match
		}
	} else {
		dst.WatermarkImageContentUrl = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(WatermarkImage)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src WatermarkImage) MarshalJSON() ([]byte, error) {
	if src.WatermarkImageContentBase64 != nil {
		return json.Marshal(&src.WatermarkImageContentBase64)
	}

	if src.WatermarkImageContentUrl != nil {
		return json.Marshal(&src.WatermarkImageContentUrl)
	}
...
type NullableWatermarkImage struct {
	value *WatermarkImage
	isSet bool
}

func (v NullableWatermarkImage) Get() *WatermarkImage {
	return v.value
}

func (v *NullableWatermarkImage) Set(val *WatermarkImage) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkImage) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkImage(val *WatermarkImage) *NullableWatermarkImage {
	return &NullableWatermarkImage{value: val, isSet: true}
}

func (v NullableWatermarkImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
