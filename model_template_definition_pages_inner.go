...
// checks if the TemplateDefinitionPagesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDefinitionPagesInner{}

// TemplateDefinitionPagesInner struct for TemplateDefinitionPagesInner
type TemplateDefinitionPagesInner struct {
	// Page width in units
...
// NewTemplateDefinitionPagesInner instantiates a new TemplateDefinitionPagesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateDefinitionPagesInner() *TemplateDefinitionPagesInner {
	this := TemplateDefinitionPagesInner{}
	return &this
}

// NewTemplateDefinitionPagesInnerWithDefaults instantiates a new TemplateDefinitionPagesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateDefinitionPagesInnerWithDefaults() *TemplateDefinitionPagesInner {
	this := TemplateDefinitionPagesInner{}
	return &this
}

// GetWidth returns the Width field value if set, zero value otherwise.
func (o *TemplateDefinitionPagesInner) GetWidth() float32 {
...
func (o *TemplateDefinitionPagesInner) GetWidthOk() (*float32, bool) {
	if o == nil || IsNil(o.Width) {
		return nil, false
	}
	return o.Width, true
...
func (o *TemplateDefinitionPagesInner) HasWidth() bool {
	if o != nil && !IsNil(o.Width) {
		return true
	}
...
func (o *TemplateDefinitionPagesInner) SetWidth(v float32) {
	o.Width = &v
}

// GetHeight returns the Height field value if set, zero value otherwise.
func (o *TemplateDefinitionPagesInner) GetHeight() float32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionPagesInner) GetHeightOk() (*float32, bool) {
	if o == nil || IsNil(o.Height) {
		return nil, false
	}
...
func (o *TemplateDefinitionPagesInner) HasHeight() bool {
	if o != nil && !IsNil(o.Height) {
		return true
	}
...
func (o *TemplateDefinitionPagesInner) SetHeight(v float32) {
	o.Height = &v
}

// GetMargins returns the Margins field value if set, zero value otherwise.
func (o *TemplateDefinitionPagesInner) GetMargins() TemplateDefinitionNewPagesInnerMargins {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionPagesInner) GetMarginsOk() (*TemplateDefinitionNewPagesInnerMargins, bool) {
	if o == nil || IsNil(o.Margins) {
		return nil, false
	}
...
func (o *TemplateDefinitionPagesInner) HasMargins() bool {
	if o != nil && !IsNil(o.Margins) {
		return true
	}
...
func (o *TemplateDefinitionPagesInner) SetMargins(v TemplateDefinitionNewPagesInnerMargins) {
	o.Margins = &v
}

// GetComponents returns the Components field value if set, zero value otherwise.
func (o *TemplateDefinitionPagesInner) GetComponents() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionPagesInner) GetComponentsOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Components) {
		return nil, false
	}
...
func (o *TemplateDefinitionPagesInner) HasComponents() bool {
	if o != nil && !IsNil(o.Components) {
		return true
	}
...
func (o *TemplateDefinitionPagesInner) SetComponents(v []map[string]interface{}) {
	o.Components = v
}

func (o TemplateDefinitionPagesInner) MarshalJSON() ([]byte, error) {
...
func (o TemplateDefinitionPagesInner) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateDefinitionPagesInner struct {
	value *TemplateDefinitionPagesInner
	isSet bool
}

func (v NullableTemplateDefinitionPagesInner) Get() *TemplateDefinitionPagesInner {
	return v.value
}

func (v *NullableTemplateDefinitionPagesInner) Set(val *TemplateDefinitionPagesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDefinitionPagesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDefinitionPagesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDefinitionPagesInner(val *TemplateDefinitionPagesInner) *NullableTemplateDefinitionPagesInner {
	return &NullableTemplateDefinitionPagesInner{value: val, isSet: true}
}

func (v NullableTemplateDefinitionPagesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDefinitionPagesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
