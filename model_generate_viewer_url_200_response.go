...
// checks if the GenerateViewerUrl200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateViewerUrl200Response{}

// GenerateViewerUrl200Response struct for GenerateViewerUrl200Response
type GenerateViewerUrl200Response struct {
	// Public URL to the PDF viewer.
	Response *string `json:"response,omitempty"`
	Meta *GenerateViewerUrl200ResponseMeta `json:"meta,omitempty"`
}
...
func NewGenerateViewerUrl200Response() *GenerateViewerUrl200Response {
	this := GenerateViewerUrl200Response{}
	return &this
}
...
func (o *GenerateViewerUrl200Response) GetMeta() GenerateViewerUrl200ResponseMeta {
	if o == nil || IsNil(o.Meta) {
		var ret GenerateViewerUrl200ResponseMeta
		return ret
	}
	return *o.Meta
}
...
// SetMeta gets a reference to the given GenerateViewerUrl200ResponseMeta and assigns it to the Meta field.
func (o *GenerateViewerUrl200Response) SetMeta(v GenerateViewerUrl200ResponseMeta) {
	o.Meta = &v
}

func (o GenerateViewerUrl200Response) MarshalJSON() ([]byte, error) {
...
func (o GenerateViewerUrl200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGenerateViewerUrl200Response struct {
	value *GenerateViewerUrl200Response
	isSet bool
}

func (v NullableGenerateViewerUrl200Response) Get() *GenerateViewerUrl200Response {
	return v.value
}

func (v *NullableGenerateViewerUrl200Response) Set(val *GenerateViewerUrl200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateViewerUrl200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateViewerUrl200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateViewerUrl200Response(val *GenerateViewerUrl200Response) *NullableGenerateViewerUrl200Response {
	return &NullableGenerateViewerUrl200Response{value: val, isSet: true}
}

func (v NullableGenerateViewerUrl200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateViewerUrl200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
