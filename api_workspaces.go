...
func (r ApiCreateWorkspaceRequest) Execute() (*InlineObject8, *http.Response, error) {
...
func (a *WorkspacesAPIService) CreateWorkspaceExecute(r ApiCreateWorkspaceRequest) (*InlineObject8, *http.Response, error) {
	var (
...
*/
func (a *WorkspacesAPIService) DeleteWorkspace(ctx context.Context, workspaceIdentifier string) ApiDeleteWorkspaceRequest {
	return ApiDeleteWorkspaceRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *WorkspacesAPIService) DeleteWorkspaceExecute(r ApiDeleteWorkspaceRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/workspaces/{workspaceIdentifier}"
	localVarPath = strings.Replace(localVarPath, "{"+"workspaceIdentifier"+"}", url.PathEscape(parameterValueToString(r.workspaceIdentifier, "workspaceIdentifier")), -1)
...
func (r ApiGetWorkspaceRequest) Execute() (*InlineObject8, *http.Response, error) {
...
*/
func (a *WorkspacesAPIService) GetWorkspace(ctx context.Context, workspaceIdentifier string) ApiGetWorkspaceRequest {
	return ApiGetWorkspaceRequest{
		ApiService: a,
		ctx: ctx,
		workspaceIdentifier: workspaceIdentifier,
...
// Execute executes the request
//  @return InlineObject8
func (a *WorkspacesAPIService) GetWorkspaceExecute(r ApiGetWorkspaceRequest) (*InlineObject8, *http.Response, error) {
	var (
...
func (r ApiGetWorkspacesRequest) Page(page int32) ApiGetWorkspacesRequest {
	r.page = &page
	return r
}

// Pagination: How many records to return per page
func (r ApiGetWorkspacesRequest) PerPage(perPage int32) ApiGetWorkspacesRequest {
	r.perPage = &perPage
	return r
}

func (r ApiGetWorkspacesRequest) Execute() (*InlineObject5, *http.Response, error) {
...
*/
func (a *WorkspacesAPIService) GetWorkspaces(ctx context.Context) ApiGetWorkspacesRequest {
	return ApiGetWorkspacesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkspacesAPIService) GetWorkspacesExecute(r ApiGetWorkspacesRequest) (*InlineObject5, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesAPIService.GetWorkspaces")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
