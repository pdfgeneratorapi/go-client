...
// checks if the FormFillBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormFillBase64{}

// FormFillBase64 struct for FormFillBase64
type FormFillBase64 struct {
...
type _FormFillBase64 FormFillBase64
...
func (o FormFillBase64) MarshalJSON() ([]byte, error) {
...
func (o FormFillBase64) ToMap() (map[string]interface{}, error) {
...
func (o *FormFillBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varFormFillBase64 := _FormFillBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormFillBase64)

	if err != nil {
		return err
	}

	*o = FormFillBase64(varFormFillBase64)

	return err
}

type NullableFormFillBase64 struct {
	value *FormFillBase64
	isSet bool
}

func (v NullableFormFillBase64) Get() *FormFillBase64 {
	return v.value
}

func (v *NullableFormFillBase64) Set(val *FormFillBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableFormFillBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableFormFillBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormFillBase64(val *FormFillBase64) *NullableFormFillBase64 {
	return &NullableFormFillBase64{value: val, isSet: true}
}

func (v NullableFormFillBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormFillBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
