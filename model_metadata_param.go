...
// checks if the MetadataParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataParam{}

// MetadataParam Metadata object (optional)
...
func NewMetadataParam() *MetadataParam {
	this := MetadataParam{}
	var author string = "Organization name"
	this.Author = &author
...
func (o MetadataParam) MarshalJSON() ([]byte, error) {
...
func (o MetadataParam) ToMap() (map[string]interface{}, error) {
...
type NullableMetadataParam struct {
	value *MetadataParam
	isSet bool
}

func (v NullableMetadataParam) Get() *MetadataParam {
	return v.value
}

func (v *NullableMetadataParam) Set(val *MetadataParam) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataParam) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataParam(val *MetadataParam) *NullableMetadataParam {
	return &NullableMetadataParam{value: val, isSet: true}
}

func (v NullableMetadataParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
