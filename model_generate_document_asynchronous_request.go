...
// checks if the GenerateDocumentAsynchronousRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateDocumentAsynchronousRequest{}

// GenerateDocumentAsynchronousRequest struct for GenerateDocumentAsynchronousRequest
type GenerateDocumentAsynchronousRequest struct {
	Template *TemplateParam `json:"template,omitempty"`
	Callback *CallbackParam `json:"callback,omitempty"`
	Format *FormatParam `json:"format,omitempty"`
	Output *AsyncOutputParam `json:"output,omitempty"`
	...
	MakeAccessible *bool `json:"make_accessible,omitempty"`
...
func NewGenerateDocumentAsynchronousRequest() *GenerateDocumentAsynchronousRequest {
	this := GenerateDocumentAsynchronousRequest{}
	var format FormatParam = FORMATPARAM_PDF
	this.Format = &format
	var output AsyncOutputParam = ASYNCOUTPUTPARAM_BASE64
	this.Output = &output
	var name string = ""
	this.Name = &name
	var testing bool = false
	this.Testing = &testing
	var makeAccessible bool = false
...
// SetTemplate gets a reference to the given TemplateParam and assigns it to the Template field.
...
// SetCallback gets a reference to the given CallbackParam and assigns it to the Callback field.
...
// SetFormat gets a reference to the given FormatParam and assigns it to the Format field.
...
// SetOutput gets a reference to the given AsyncOutputParam and assigns it to the Output field.
...
// GetMakeAccessible returns the MakeAccessible field value if set, zero value otherwise.
func (o *GenerateDocumentAsynchronousRequest) GetMakeAccessible() bool {
	if o == nil || IsNil(o.MakeAccessible) {
		var ret bool
		return ret
	}
	return *o.MakeAccessible
}

// GetMakeAccessibleOk returns a tuple with the MakeAccessible field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GenerateDocumentAsynchronousRequest) GetMakeAccessibleOk() (*bool, bool) {
	if o == nil || IsNil(o.MakeAccessible) {
		return nil, false
	}
	return o.MakeAccessible, true
}
...
// SetMakeAccessible gets a reference to the given bool and assigns it to the MakeAccessible field.
...
// SetMetadata gets a reference to the given MetadataParam and assigns it to the Metadata field.
func (o *GenerateDocumentAsynchronousRequest) SetMetadata(v MetadataParam) {
	o.Metadata = &v
}

func (o GenerateDocumentAsynchronousRequest) MarshalJSON() ([]byte, error) {
...
func (o GenerateDocumentAsynchronousRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MakeAccessible) {
		toSerialize["make_accessible"] = o.MakeAccessible
	}
	if !IsNil(o.Metadata) {
...
type NullableGenerateDocumentAsynchronousRequest struct {
	value *GenerateDocumentAsynchronousRequest
	isSet bool
}

func (v NullableGenerateDocumentAsynchronousRequest) Get() *GenerateDocumentAsynchronousRequest {
	return v.value
}

func (v *NullableGenerateDocumentAsynchronousRequest) Set(val *GenerateDocumentAsynchronousRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateDocumentAsynchronousRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateDocumentAsynchronousRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateDocumentAsynchronousRequest(val *GenerateDocumentAsynchronousRequest) *NullableGenerateDocumentAsynchronousRequest {
	return &NullableGenerateDocumentAsynchronousRequest{value: val, isSet: true}
}

func (v NullableGenerateDocumentAsynchronousRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateDocumentAsynchronousRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
