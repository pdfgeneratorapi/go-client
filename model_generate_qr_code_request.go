...
// checks if the GenerateQRCodeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateQRCodeRequest{}

// GenerateQRCodeRequest struct for GenerateQRCodeRequest
...
type _GenerateQRCodeRequest GenerateQRCodeRequest
...
func (o GenerateQRCodeRequest) MarshalJSON() ([]byte, error) {
...
func (o GenerateQRCodeRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LogoBase64) {
		toSerialize["logo_base64"] = o.LogoBase64
	}
	if !IsNil(o.LogoUrl) {
...
func (o *GenerateQRCodeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGenerateQRCodeRequest := _GenerateQRCodeRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenerateQRCodeRequest)

	if err != nil {
		return err
	}

	*o = GenerateQRCodeRequest(varGenerateQRCodeRequest)

	return err
}

type NullableGenerateQRCodeRequest struct {
	value *GenerateQRCodeRequest
	isSet bool
}

func (v NullableGenerateQRCodeRequest) Get() *GenerateQRCodeRequest {
	return v.value
}

func (v *NullableGenerateQRCodeRequest) Set(val *GenerateQRCodeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateQRCodeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateQRCodeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateQRCodeRequest(val *GenerateQRCodeRequest) *NullableGenerateQRCodeRequest {
	return &NullableGenerateQRCodeRequest{value: val, isSet: true}
}

func (v NullableGenerateQRCodeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateQRCodeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
