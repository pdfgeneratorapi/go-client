...
// checks if the DocumentUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentUser{}

// DocumentUser The user who created the version or performed the action.
type DocumentUser struct {
	FirstName *string `json:"first_name,omitempty"`
	LastName *string `json:"last_name,omitempty"`
	Email *string `json:"email,omitempty"`
	// National identification code, when provided.
	IdCode NullableString `json:"id_code,omitempty"`
...
// GetIdCode returns the IdCode field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DocumentUser) GetIdCode() string {
	if o == nil || IsNil(o.IdCode.Get()) {
		var ret string
		return ret
	}
	return *o.IdCode.Get()
...
// SetIdCode gets a reference to the given NullableString and assigns it to the IdCode field.
func (o *DocumentUser) SetIdCode(v string) {
	o.IdCode.Set(&v)
}
// SetIdCodeNil sets the value for IdCode to be an explicit nil
func (o *DocumentUser) SetIdCodeNil() {
	o.IdCode.Set(nil)
}
...
func (o DocumentUser) MarshalJSON() ([]byte, error) {
...
func (o DocumentUser) ToMap() (map[string]interface{}, error) {
	...
	if o.IdCode.IsSet() {
		toSerialize["id_code"] = o.IdCode.Get()
	}
	if o.Ip.IsSet() {
...
type NullableDocumentUser struct {
	value *DocumentUser
	isSet bool
}

func (v NullableDocumentUser) Get() *DocumentUser {
	return v.value
}

func (v *NullableDocumentUser) Set(val *DocumentUser) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentUser) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentUser(val *DocumentUser) *NullableDocumentUser {
	return &NullableDocumentUser{value: val, isSet: true}
}

func (v NullableDocumentUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
