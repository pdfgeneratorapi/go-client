...
// checks if the WatermarkImageContentBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatermarkImageContentBase64{}

// WatermarkImageContentBase64 struct for WatermarkImageContentBase64
type WatermarkImageContentBase64 struct {
	// Base64 image string
...
type _WatermarkImageContentBase64 WatermarkImageContentBase64
...
func NewWatermarkImageContentBase64(contentBase64 string) *WatermarkImageContentBase64 {
	this := WatermarkImageContentBase64{}
	this.ContentBase64 = contentBase64
	var position WatermarkPosition = WATERMARKPOSITION_CENTER
...
// SetPosition gets a reference to the given WatermarkPosition and assigns it to the Position field.
...
func (o WatermarkImageContentBase64) MarshalJSON() ([]byte, error) {
...
func (o WatermarkImageContentBase64) ToMap() (map[string]interface{}, error) {
...
func (o *WatermarkImageContentBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varWatermarkImageContentBase64 := _WatermarkImageContentBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWatermarkImageContentBase64)

	if err != nil {
		return err
	}

	*o = WatermarkImageContentBase64(varWatermarkImageContentBase64)

	return err
}

type NullableWatermarkImageContentBase64 struct {
	value *WatermarkImageContentBase64
	isSet bool
}

func (v NullableWatermarkImageContentBase64) Get() *WatermarkImageContentBase64 {
	return v.value
}

func (v *NullableWatermarkImageContentBase64) Set(val *WatermarkImageContentBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkImageContentBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkImageContentBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkImageContentBase64(val *WatermarkImageContentBase64) *NullableWatermarkImageContentBase64 {
	return &NullableWatermarkImageContentBase64{value: val, isSet: true}
}

func (v NullableWatermarkImageContentBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkImageContentBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
