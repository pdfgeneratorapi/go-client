...
// checks if the InlineObject18Meta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject18Meta{}

// InlineObject18Meta struct for InlineObject18Meta
type InlineObject18Meta struct {
	// Form sharing unique identifier
	PublicId *string `json:"public_id,omitempty"`
}

// NewInlineObject18Meta instantiates a new InlineObject18Meta object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineObject18Meta() *InlineObject18Meta {
	this := InlineObject18Meta{}
	return &this
}

// NewInlineObject18MetaWithDefaults instantiates a new InlineObject18Meta object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineObject18MetaWithDefaults() *InlineObject18Meta {
	this := InlineObject18Meta{}
	return &this
}

// GetPublicId returns the PublicId field value if set, zero value otherwise.
func (o *InlineObject18Meta) GetPublicId() string {
...
func (o *InlineObject18Meta) GetPublicIdOk() (*string, bool) {
	if o == nil || IsNil(o.PublicId) {
		return nil, false
	}
...
func (o *InlineObject18Meta) HasPublicId() bool {
	if o != nil && !IsNil(o.PublicId) {
		return true
	}
...
func (o *InlineObject18Meta) SetPublicId(v string) {
	o.PublicId = &v
}

func (o InlineObject18Meta) MarshalJSON() ([]byte, error) {
...
func (o InlineObject18Meta) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject18Meta struct {
	value *InlineObject18Meta
	isSet bool
}

func (v NullableInlineObject18Meta) Get() *InlineObject18Meta {
	return v.value
}

func (v *NullableInlineObject18Meta) Set(val *InlineObject18Meta) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject18Meta) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject18Meta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject18Meta(val *InlineObject18Meta) *NullableInlineObject18Meta {
	return &NullableInlineObject18Meta{value: val, isSet: true}
}

func (v NullableInlineObject18Meta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject18Meta) UnmarshalJSON(src []byte) error {
	v.isSet = true
