...
type InlineObject7 struct {
	Response *InlineObject7Response `json:"response,omitempty"`
}
...
func (o *InlineObject7) GetResponse() InlineObject7Response {
	if o == nil || IsNil(o.Response) {
		var ret InlineObject7Response
		return ret
	}
	return *o.Response
}
...
func (o *InlineObject7) GetResponseOk() (*InlineObject7Response, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject7) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given InlineObject7Response and assigns it to the Response field.
func (o *InlineObject7) SetResponse(v InlineObject7Response) {
	o.Response = &v
}
