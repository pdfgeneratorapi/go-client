...
// checks if the EncryptAndDecryptUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncryptAndDecryptUrl{}

// EncryptAndDecryptUrl struct for EncryptAndDecryptUrl
type EncryptAndDecryptUrl struct {
...
type _EncryptAndDecryptUrl EncryptAndDecryptUrl
...
func (o EncryptAndDecryptUrl) MarshalJSON() ([]byte, error) {
...
func (o EncryptAndDecryptUrl) ToMap() (map[string]interface{}, error) {
...
func (o *EncryptAndDecryptUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varEncryptAndDecryptUrl := _EncryptAndDecryptUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEncryptAndDecryptUrl)

	if err != nil {
		return err
	}

	*o = EncryptAndDecryptUrl(varEncryptAndDecryptUrl)

	return err
}

type NullableEncryptAndDecryptUrl struct {
	value *EncryptAndDecryptUrl
	isSet bool
}

func (v NullableEncryptAndDecryptUrl) Get() *EncryptAndDecryptUrl {
	return v.value
}

func (v *NullableEncryptAndDecryptUrl) Set(val *EncryptAndDecryptUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableEncryptAndDecryptUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableEncryptAndDecryptUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncryptAndDecryptUrl(val *EncryptAndDecryptUrl) *NullableEncryptAndDecryptUrl {
	return &NullableEncryptAndDecryptUrl{value: val, isSet: true}
}

func (v NullableEncryptAndDecryptUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncryptAndDecryptUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
