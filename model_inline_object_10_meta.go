...
// InlineObject10Meta struct for InlineObject10Meta
...
func (o *InlineObject10Meta) GetName() string {
...
func (o *InlineObject10Meta) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *InlineObject10Meta) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InlineObject10Meta) SetName(v string) {
	o.Name = &v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *InlineObject10Meta) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject10Meta) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *InlineObject10Meta) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *InlineObject10Meta) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetEncoding returns the Encoding field value if set, zero value otherwise.
func (o *InlineObject10Meta) GetEncoding() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject10Meta) GetEncodingOk() (*string, bool) {
	if o == nil || IsNil(o.Encoding) {
		return nil, false
	}
...
func (o *InlineObject10Meta) HasEncoding() bool {
	if o != nil && !IsNil(o.Encoding) {
		return true
	}
...
func (o *InlineObject10Meta) SetEncoding(v string) {
	o.Encoding = &v
}

// GetContentType returns the ContentType field value if set, zero value otherwise.
func (o *InlineObject10Meta) GetContentType() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject10Meta) GetContentTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ContentType) {
		return nil, false
	}
...
func (o *InlineObject10Meta) HasContentType() bool {
	if o != nil && !IsNil(o.ContentType) {
		return true
	}
...
func (o *InlineObject10Meta) SetContentType(v string) {
	o.ContentType = &v
}
