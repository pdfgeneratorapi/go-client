...
// checks if the ImportFormBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportFormBase64{}

// ImportFormBase64 struct for ImportFormBase64
type ImportFormBase64 struct {
	// PDF file from base64 string to import
	FileBase64 string `json:"file_base64"`
	Form *FormConfigurationNew `json:"form,omitempty"`
}

type _ImportFormBase64 ImportFormBase64
...
// SetForm gets a reference to the given FormConfigurationNew and assigns it to the Form field.
func (o *ImportFormBase64) SetForm(v FormConfigurationNew) {
	o.Form = &v
}

func (o ImportFormBase64) MarshalJSON() ([]byte, error) {
...
func (o ImportFormBase64) ToMap() (map[string]interface{}, error) {
...
func (o *ImportFormBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varImportFormBase64 := _ImportFormBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportFormBase64)

	if err != nil {
		return err
	}

	*o = ImportFormBase64(varImportFormBase64)

	return err
}

type NullableImportFormBase64 struct {
	value *ImportFormBase64
	isSet bool
}

func (v NullableImportFormBase64) Get() *ImportFormBase64 {
	return v.value
}

func (v *NullableImportFormBase64) Set(val *ImportFormBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableImportFormBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableImportFormBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportFormBase64(val *ImportFormBase64) *NullableImportFormBase64 {
	return &NullableImportFormBase64{value: val, isSet: true}
}

func (v NullableImportFormBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportFormBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
