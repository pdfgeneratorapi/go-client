...
func (r ApiGetTemplateLibraryItemRequest) Execute() (*InlineObject18, *http.Response, error) {
...
func (a *TemplateLibraryAPIService) GetTemplateLibraryItemExecute(r ApiGetTemplateLibraryItemRequest) (*InlineObject18, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
