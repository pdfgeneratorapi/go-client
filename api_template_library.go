...
func (r ApiGetTemplateLibraryItemRequest) Execute() (*InlineObject19, *http.Response, error) {
...
func (a *TemplateLibraryAPIService) GetTemplateLibraryItemExecute(r ApiGetTemplateLibraryItemRequest) (*InlineObject19, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
