...
// TemplateLibraryAPIService TemplateLibraryAPI service
type TemplateLibraryAPIService service

type ApiGetTemplateLibraryRequest struct {
	ctx context.Context
	ApiService *TemplateLibraryAPIService
	tags *string
}

// Filter template by tags
func (r ApiGetTemplateLibraryRequest) Tags(tags string) ApiGetTemplateLibraryRequest {
	r.tags = &tags
	return r
}

func (r ApiGetTemplateLibraryRequest) Execute() (*GetTemplateLibrary200Response, *http.Response, error) {
	return r.ApiService.GetTemplateLibraryExecute(r)
}

/*
GetTemplateLibrary Get template library

Returns a list of publicly available templates from the template library.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetTemplateLibraryRequest
*/
func (a *TemplateLibraryAPIService) GetTemplateLibrary(ctx context.Context) ApiGetTemplateLibraryRequest {
	return ApiGetTemplateLibraryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TemplateLibraryAPIService) GetTemplateLibraryExecute(r ApiGetTemplateLibraryRequest) (*GetTemplateLibrary200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetTemplateLibrary200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemplateLibraryAPIService.GetTemplateLibrary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/templates/library"
...
type ApiGetTemplateLibraryItemRequest struct {
	ctx context.Context
	ApiService *TemplateLibraryAPIService
	publicId string
}

func (r ApiGetTemplateLibraryItemRequest) Execute() (*InlineObject16, *http.Response, error) {
	return r.ApiService.GetTemplateLibraryItemExecute(r)
}

/*
GetTemplateLibraryItem Open template from the library
...
Returns the template definition for a public template identified by its `public_id`.
 ...
 @return ApiGetTemplateLibraryItemRequest
*/
func (a *TemplateLibraryAPIService) GetTemplateLibraryItem(ctx context.Context, publicId string) ApiGetTemplateLibraryItemRequest {
	return ApiGetTemplateLibraryItemRequest{
		ApiService: a,
		ctx: ctx,
		publicId: publicId,
...
func (a *TemplateLibraryAPIService) GetTemplateLibraryItemExecute(r ApiGetTemplateLibraryItemRequest) (*InlineObject16, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemplateLibraryAPIService.GetTemplateLibraryItem")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/templates/library/{publicId}"
