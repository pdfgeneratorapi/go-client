...
// checks if the CreateFacturXEInvoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFacturXEInvoiceRequest{}

// CreateFacturXEInvoiceRequest struct for CreateFacturXEInvoiceRequest
type CreateFacturXEInvoiceRequest struct {
	Template CreateFacturXEInvoiceRequestTemplate `json:"template"`
...
type _CreateFacturXEInvoiceRequest CreateFacturXEInvoiceRequest
...
func NewCreateFacturXEInvoiceRequest(template CreateFacturXEInvoiceRequestTemplate) *CreateFacturXEInvoiceRequest {
	this := CreateFacturXEInvoiceRequest{}
...
func (o *CreateFacturXEInvoiceRequest) GetTemplate() CreateFacturXEInvoiceRequestTemplate {
	if o == nil {
		var ret CreateFacturXEInvoiceRequestTemplate
		return ret
	}
...
func (o CreateFacturXEInvoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateFacturXEInvoiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateFacturXEInvoiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateFacturXEInvoiceRequest := _CreateFacturXEInvoiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateFacturXEInvoiceRequest)

	if err != nil {
		return err
	}

	*o = CreateFacturXEInvoiceRequest(varCreateFacturXEInvoiceRequest)

	return err
}

type NullableCreateFacturXEInvoiceRequest struct {
	value *CreateFacturXEInvoiceRequest
	isSet bool
}

func (v NullableCreateFacturXEInvoiceRequest) Get() *CreateFacturXEInvoiceRequest {
	return v.value
}

func (v *NullableCreateFacturXEInvoiceRequest) Set(val *CreateFacturXEInvoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFacturXEInvoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFacturXEInvoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFacturXEInvoiceRequest(val *CreateFacturXEInvoiceRequest) *NullableCreateFacturXEInvoiceRequest {
	return &NullableCreateFacturXEInvoiceRequest{value: val, isSet: true}
}

func (v NullableCreateFacturXEInvoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFacturXEInvoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
