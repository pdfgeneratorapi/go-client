...
// AddWatermarkRequest - struct for AddWatermarkRequest
type AddWatermarkRequest struct {
	WatermarkBase64 *WatermarkBase64
	WatermarkFileUrl *WatermarkFileUrl
}

// WatermarkBase64AsAddWatermarkRequest is a convenience function that returns WatermarkBase64 wrapped in AddWatermarkRequest
func WatermarkBase64AsAddWatermarkRequest(v *WatermarkBase64) AddWatermarkRequest {
	return AddWatermarkRequest{
		WatermarkBase64: v,
	}
}

// WatermarkFileUrlAsAddWatermarkRequest is a convenience function that returns WatermarkFileUrl wrapped in AddWatermarkRequest
func WatermarkFileUrlAsAddWatermarkRequest(v *WatermarkFileUrl) AddWatermarkRequest {
	return AddWatermarkRequest{
		WatermarkFileUrl: v,
	}
}
...
func (dst *AddWatermarkRequest) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into WatermarkBase64
	err = newStrictDecoder(data).Decode(&dst.WatermarkBase64)
	if err == nil {
		jsonWatermarkBase64, _ := json.Marshal(dst.WatermarkBase64)
		if string(jsonWatermarkBase64) == "{}" { // empty struct
			dst.WatermarkBase64 = nil
		} else {
			if err = validator.Validate(dst.WatermarkBase64); err != nil {
				dst.WatermarkBase64 = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into WatermarkFileUrl
	err = newStrictDecoder(data).Decode(&dst.WatermarkFileUrl)
	if err == nil {
		jsonWatermarkFileUrl, _ := json.Marshal(dst.WatermarkFileUrl)
		if string(jsonWatermarkFileUrl) == "{}" { // empty struct
			dst.WatermarkFileUrl = nil
		} else {
			if err = validator.Validate(dst.WatermarkFileUrl); err != nil {
				dst.WatermarkFileUrl = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(AddWatermarkRequest)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(AddWatermarkRequest)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src AddWatermarkRequest) MarshalJSON() ([]byte, error) {
	if src.WatermarkBase64 != nil {
		return json.Marshal(&src.WatermarkBase64)
	}

	if src.WatermarkFileUrl != nil {
		return json.Marshal(&src.WatermarkFileUrl)
	}
...
func (obj *AddWatermarkRequest) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.WatermarkBase64 != nil {
		return obj.WatermarkBase64
	}

	if obj.WatermarkFileUrl != nil {
		return obj.WatermarkFileUrl
	}
...
func (obj AddWatermarkRequest) GetActualInstanceValue() (interface{}) {
	if obj.WatermarkBase64 != nil {
		return *obj.WatermarkBase64
	}
...
type NullableAddWatermarkRequest struct {
	value *AddWatermarkRequest
	isSet bool
}

func (v NullableAddWatermarkRequest) Get() *AddWatermarkRequest {
	return v.value
}

func (v *NullableAddWatermarkRequest) Set(val *AddWatermarkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddWatermarkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddWatermarkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddWatermarkRequest(val *AddWatermarkRequest) *NullableAddWatermarkRequest {
	return &NullableAddWatermarkRequest{value: val, isSet: true}
}

func (v NullableAddWatermarkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddWatermarkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
