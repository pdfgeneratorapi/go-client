...
// checks if the TemplateDefinitionNewPagesInnerMargins type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDefinitionNewPagesInnerMargins{}

// TemplateDefinitionNewPagesInnerMargins struct for TemplateDefinitionNewPagesInnerMargins
type TemplateDefinitionNewPagesInnerMargins struct {
...
// NewTemplateDefinitionNewPagesInnerMargins instantiates a new TemplateDefinitionNewPagesInnerMargins object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateDefinitionNewPagesInnerMargins() *TemplateDefinitionNewPagesInnerMargins {
	this := TemplateDefinitionNewPagesInnerMargins{}
	return &this
}

// NewTemplateDefinitionNewPagesInnerMarginsWithDefaults instantiates a new TemplateDefinitionNewPagesInnerMargins object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateDefinitionNewPagesInnerMarginsWithDefaults() *TemplateDefinitionNewPagesInnerMargins {
	this := TemplateDefinitionNewPagesInnerMargins{}
	return &this
}

// GetRight returns the Right field value if set, zero value otherwise.
func (o *TemplateDefinitionNewPagesInnerMargins) GetRight() float32 {
...
func (o *TemplateDefinitionNewPagesInnerMargins) GetRightOk() (*float32, bool) {
	if o == nil || IsNil(o.Right) {
		return nil, false
	}
	return o.Right, true
...
func (o *TemplateDefinitionNewPagesInnerMargins) HasRight() bool {
	if o != nil && !IsNil(o.Right) {
		return true
	}
...
func (o *TemplateDefinitionNewPagesInnerMargins) SetRight(v float32) {
	o.Right = &v
}

// GetBottom returns the Bottom field value if set, zero value otherwise.
func (o *TemplateDefinitionNewPagesInnerMargins) GetBottom() float32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionNewPagesInnerMargins) GetBottomOk() (*float32, bool) {
	if o == nil || IsNil(o.Bottom) {
		return nil, false
	}
...
func (o *TemplateDefinitionNewPagesInnerMargins) HasBottom() bool {
	if o != nil && !IsNil(o.Bottom) {
		return true
	}
...
func (o *TemplateDefinitionNewPagesInnerMargins) SetBottom(v float32) {
	o.Bottom = &v
}

func (o TemplateDefinitionNewPagesInnerMargins) MarshalJSON() ([]byte, error) {
...
func (o TemplateDefinitionNewPagesInnerMargins) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateDefinitionNewPagesInnerMargins struct {
	value *TemplateDefinitionNewPagesInnerMargins
	isSet bool
}

func (v NullableTemplateDefinitionNewPagesInnerMargins) Get() *TemplateDefinitionNewPagesInnerMargins {
	return v.value
}

func (v *NullableTemplateDefinitionNewPagesInnerMargins) Set(val *TemplateDefinitionNewPagesInnerMargins) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDefinitionNewPagesInnerMargins) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDefinitionNewPagesInnerMargins) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDefinitionNewPagesInnerMargins(val *TemplateDefinitionNewPagesInnerMargins) *NullableTemplateDefinitionNewPagesInnerMargins {
	return &NullableTemplateDefinitionNewPagesInnerMargins{value: val, isSet: true}
}

func (v NullableTemplateDefinitionNewPagesInnerMargins) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDefinitionNewPagesInnerMargins) UnmarshalJSON(src []byte) error {
	v.isSet = true
