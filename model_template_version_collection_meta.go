...
// checks if the TemplateVersionCollectionMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateVersionCollectionMeta{}

// TemplateVersionCollectionMeta struct for TemplateVersionCollectionMeta
type TemplateVersionCollectionMeta struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	PerPage *int32 `json:"per_page,omitempty"`
	LastPage *int32 `json:"last_page,omitempty"`
}

// NewTemplateVersionCollectionMeta instantiates a new TemplateVersionCollectionMeta object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateVersionCollectionMeta() *TemplateVersionCollectionMeta {
	this := TemplateVersionCollectionMeta{}
	return &this
}

// NewTemplateVersionCollectionMetaWithDefaults instantiates a new TemplateVersionCollectionMeta object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateVersionCollectionMetaWithDefaults() *TemplateVersionCollectionMeta {
	this := TemplateVersionCollectionMeta{}
	return &this
}

// GetCurrentPage returns the CurrentPage field value if set, zero value otherwise.
func (o *TemplateVersionCollectionMeta) GetCurrentPage() int32 {
...
func (o *TemplateVersionCollectionMeta) GetCurrentPageOk() (*int32, bool) {
	if o == nil || IsNil(o.CurrentPage) {
		return nil, false
	}
...
func (o *TemplateVersionCollectionMeta) HasCurrentPage() bool {
	if o != nil && !IsNil(o.CurrentPage) {
		return true
	}
...
func (o *TemplateVersionCollectionMeta) SetCurrentPage(v int32) {
	o.CurrentPage = &v
}

// GetPerPage returns the PerPage field value if set, zero value otherwise.
func (o *TemplateVersionCollectionMeta) GetPerPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateVersionCollectionMeta) GetPerPageOk() (*int32, bool) {
	if o == nil || IsNil(o.PerPage) {
		return nil, false
	}
...
func (o *TemplateVersionCollectionMeta) HasPerPage() bool {
	if o != nil && !IsNil(o.PerPage) {
		return true
	}
...
func (o *TemplateVersionCollectionMeta) SetPerPage(v int32) {
	o.PerPage = &v
}

// GetLastPage returns the LastPage field value if set, zero value otherwise.
func (o *TemplateVersionCollectionMeta) GetLastPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateVersionCollectionMeta) GetLastPageOk() (*int32, bool) {
	if o == nil || IsNil(o.LastPage) {
		return nil, false
	}
...
func (o *TemplateVersionCollectionMeta) HasLastPage() bool {
	if o != nil && !IsNil(o.LastPage) {
		return true
	}
...
func (o *TemplateVersionCollectionMeta) SetLastPage(v int32) {
	o.LastPage = &v
}

func (o TemplateVersionCollectionMeta) MarshalJSON() ([]byte, error) {
...
func (o TemplateVersionCollectionMeta) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateVersionCollectionMeta struct {
	value *TemplateVersionCollectionMeta
	isSet bool
}

func (v NullableTemplateVersionCollectionMeta) Get() *TemplateVersionCollectionMeta {
	return v.value
}

func (v *NullableTemplateVersionCollectionMeta) Set(val *TemplateVersionCollectionMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateVersionCollectionMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateVersionCollectionMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateVersionCollectionMeta(val *TemplateVersionCollectionMeta) *NullableTemplateVersionCollectionMeta {
	return &NullableTemplateVersionCollectionMeta{value: val, isSet: true}
}

func (v NullableTemplateVersionCollectionMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateVersionCollectionMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
