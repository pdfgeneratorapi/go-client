...
// InlineObject14ResponseValueDefault - Default field value
type InlineObject14ResponseValueDefault struct {
	ArrayOfString *[]string
	Bool *bool
	String *string
}

// []stringAsInlineObject14ResponseValueDefault is a convenience function that returns []string wrapped in InlineObject14ResponseValueDefault
func ArrayOfStringAsInlineObject14ResponseValueDefault(v *[]string) InlineObject14ResponseValueDefault {
	return InlineObject14ResponseValueDefault{
		ArrayOfString: v,
	}
}

// boolAsInlineObject14ResponseValueDefault is a convenience function that returns bool wrapped in InlineObject14ResponseValueDefault
func BoolAsInlineObject14ResponseValueDefault(v *bool) InlineObject14ResponseValueDefault {
	return InlineObject14ResponseValueDefault{
		Bool: v,
	}
}
...
// stringAsInlineObject14ResponseValueDefault is a convenience function that returns string wrapped in InlineObject14ResponseValueDefault
func StringAsInlineObject14ResponseValueDefault(v *string) InlineObject14ResponseValueDefault {
	return InlineObject14ResponseValueDefault{
		String: v,
	}
}
...
func (dst *InlineObject14ResponseValueDefault) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(InlineObject14ResponseValueDefault)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(InlineObject14ResponseValueDefault)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src InlineObject14ResponseValueDefault) MarshalJSON() ([]byte, error) {
...
func (obj *InlineObject14ResponseValueDefault) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj InlineObject14ResponseValueDefault) GetActualInstanceValue() (interface{}) {
	if obj.ArrayOfString != nil {
		return *obj.ArrayOfString
	}
...
type NullableInlineObject14ResponseValueDefault struct {
	value *InlineObject14ResponseValueDefault
	isSet bool
}

func (v NullableInlineObject14ResponseValueDefault) Get() *InlineObject14ResponseValueDefault {
	return v.value
}

func (v *NullableInlineObject14ResponseValueDefault) Set(val *InlineObject14ResponseValueDefault) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject14ResponseValueDefault) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject14ResponseValueDefault) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject14ResponseValueDefault(val *InlineObject14ResponseValueDefault) *NullableInlineObject14ResponseValueDefault {
	return &NullableInlineObject14ResponseValueDefault{value: val, isSet: true}
}

func (v NullableInlineObject14ResponseValueDefault) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject14ResponseValueDefault) UnmarshalJSON(src []byte) error {
	v.isSet = true
