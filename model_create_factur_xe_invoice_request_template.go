...
// checks if the CreateFacturXEInvoiceRequestTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFacturXEInvoiceRequestTemplate{}

// CreateFacturXEInvoiceRequestTemplate Template id, version, version id and data
type CreateFacturXEInvoiceRequestTemplate struct {
	// Template ID
...
func NewCreateFacturXEInvoiceRequestTemplate() *CreateFacturXEInvoiceRequestTemplate {
	this := CreateFacturXEInvoiceRequestTemplate{}
	return &this
}
...
func (o CreateFacturXEInvoiceRequestTemplate) MarshalJSON() ([]byte, error) {
...
func (o CreateFacturXEInvoiceRequestTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableCreateFacturXEInvoiceRequestTemplate struct {
	value *CreateFacturXEInvoiceRequestTemplate
	isSet bool
}

func (v NullableCreateFacturXEInvoiceRequestTemplate) Get() *CreateFacturXEInvoiceRequestTemplate {
	return v.value
}

func (v *NullableCreateFacturXEInvoiceRequestTemplate) Set(val *CreateFacturXEInvoiceRequestTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFacturXEInvoiceRequestTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFacturXEInvoiceRequestTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFacturXEInvoiceRequestTemplate(val *CreateFacturXEInvoiceRequestTemplate) *NullableCreateFacturXEInvoiceRequestTemplate {
	return &NullableCreateFacturXEInvoiceRequestTemplate{value: val, isSet: true}
}

func (v NullableCreateFacturXEInvoiceRequestTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFacturXEInvoiceRequestTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
