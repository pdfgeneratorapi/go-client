...
// checks if the StoreDocumentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoreDocumentRequest{}

// StoreDocumentRequest struct for StoreDocumentRequest
...
func (o StoreDocumentRequest) MarshalJSON() ([]byte, error) {
...
func (o StoreDocumentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableStoreDocumentRequest struct {
	value *StoreDocumentRequest
	isSet bool
}

func (v NullableStoreDocumentRequest) Get() *StoreDocumentRequest {
	return v.value
}

func (v *NullableStoreDocumentRequest) Set(val *StoreDocumentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStoreDocumentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStoreDocumentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoreDocumentRequest(val *StoreDocumentRequest) *NullableStoreDocumentRequest {
	return &NullableStoreDocumentRequest{value: val, isSet: true}
}

func (v NullableStoreDocumentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoreDocumentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
