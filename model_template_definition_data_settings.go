...
// checks if the TemplateDefinitionDataSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDefinitionDataSettings{}
...
// NewTemplateDefinitionDataSettings instantiates a new TemplateDefinitionDataSettings object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateDefinitionDataSettings() *TemplateDefinitionDataSettings {
	this := TemplateDefinitionDataSettings{}
	return &this
}

// NewTemplateDefinitionDataSettingsWithDefaults instantiates a new TemplateDefinitionDataSettings object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateDefinitionDataSettingsWithDefaults() *TemplateDefinitionDataSettings {
	this := TemplateDefinitionDataSettings{}
	return &this
}

// GetSortBy returns the SortBy field value if set, zero value otherwise.
func (o *TemplateDefinitionDataSettings) GetSortBy() []map[string]interface{} {
...
func (o *TemplateDefinitionDataSettings) GetSortByOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.SortBy) {
		return nil, false
	}
...
func (o *TemplateDefinitionDataSettings) HasSortBy() bool {
	if o != nil && !IsNil(o.SortBy) {
		return true
	}
...
func (o *TemplateDefinitionDataSettings) SetSortBy(v []map[string]interface{}) {
	o.SortBy = v
}

// GetFilterBy returns the FilterBy field value if set, zero value otherwise.
func (o *TemplateDefinitionDataSettings) GetFilterBy() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionDataSettings) GetFilterByOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.FilterBy) {
		return nil, false
	}
...
func (o *TemplateDefinitionDataSettings) HasFilterBy() bool {
	if o != nil && !IsNil(o.FilterBy) {
		return true
	}
...
func (o *TemplateDefinitionDataSettings) SetFilterBy(v []map[string]interface{}) {
	o.FilterBy = v
}

func (o TemplateDefinitionDataSettings) MarshalJSON() ([]byte, error) {
...
func (o TemplateDefinitionDataSettings) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateDefinitionDataSettings struct {
	value *TemplateDefinitionDataSettings
	isSet bool
}

func (v NullableTemplateDefinitionDataSettings) Get() *TemplateDefinitionDataSettings {
	return v.value
}

func (v *NullableTemplateDefinitionDataSettings) Set(val *TemplateDefinitionDataSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDefinitionDataSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDefinitionDataSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDefinitionDataSettings(val *TemplateDefinitionDataSettings) *NullableTemplateDefinitionDataSettings {
	return &NullableTemplateDefinitionDataSettings{value: val, isSet: true}
}

func (v NullableTemplateDefinitionDataSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDefinitionDataSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
