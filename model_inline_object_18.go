...
type InlineObject18 struct {
	...
	Meta *InlineObject18Meta `json:"meta,omitempty"`
}
...
// SetMeta gets a reference to the given InlineObject18Meta and assigns it to the Meta field.
