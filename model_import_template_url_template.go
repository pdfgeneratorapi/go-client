...
// checks if the ImportTemplateUrlTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportTemplateUrlTemplate{}

// ImportTemplateUrlTemplate struct for ImportTemplateUrlTemplate
type ImportTemplateUrlTemplate struct {
	// Template name
	Name string `json:"name"`
}

type _ImportTemplateUrlTemplate ImportTemplateUrlTemplate

// NewImportTemplateUrlTemplate instantiates a new ImportTemplateUrlTemplate object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewImportTemplateUrlTemplate(name string) *ImportTemplateUrlTemplate {
	this := ImportTemplateUrlTemplate{}
	this.Name = name
	return &this
}

// NewImportTemplateUrlTemplateWithDefaults instantiates a new ImportTemplateUrlTemplate object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewImportTemplateUrlTemplateWithDefaults() *ImportTemplateUrlTemplate {
	this := ImportTemplateUrlTemplate{}
	return &this
}

// GetName returns the Name field value
func (o *ImportTemplateUrlTemplate) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ImportTemplateUrlTemplate) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *ImportTemplateUrlTemplate) SetName(v string) {
	o.Name = v
}

func (o ImportTemplateUrlTemplate) MarshalJSON() ([]byte, error) {
...
func (o ImportTemplateUrlTemplate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *ImportTemplateUrlTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varImportTemplateUrlTemplate := _ImportTemplateUrlTemplate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportTemplateUrlTemplate)

	if err != nil {
		return err
	}

	*o = ImportTemplateUrlTemplate(varImportTemplateUrlTemplate)

	return err
}

type NullableImportTemplateUrlTemplate struct {
	value *ImportTemplateUrlTemplate
	isSet bool
}

func (v NullableImportTemplateUrlTemplate) Get() *ImportTemplateUrlTemplate {
	return v.value
}

func (v *NullableImportTemplateUrlTemplate) Set(val *ImportTemplateUrlTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableImportTemplateUrlTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableImportTemplateUrlTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportTemplateUrlTemplate(val *ImportTemplateUrlTemplate) *NullableImportTemplateUrlTemplate {
	return &NullableImportTemplateUrlTemplate{value: val, isSet: true}
}

func (v NullableImportTemplateUrlTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportTemplateUrlTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
