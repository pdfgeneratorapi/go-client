...
// checks if the GenerateDocumentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateDocumentRequest{}

// GenerateDocumentRequest struct for GenerateDocumentRequest
type GenerateDocumentRequest struct {
	...
	Output *OutputParam `json:"output,omitempty"`
...
func NewGenerateDocumentRequest() *GenerateDocumentRequest {
	this := GenerateDocumentRequest{}
	var format FormatParam = FORMATPARAM_PDF
	this.Format = &format
	var output OutputParam = OUTPUTPARAM_BASE64
	this.Output = &output
	var name string = ""
	this.Name = &name
...
// SetOutput gets a reference to the given OutputParam and assigns it to the Output field.
...
func (o GenerateDocumentRequest) MarshalJSON() ([]byte, error) {
...
func (o GenerateDocumentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGenerateDocumentRequest struct {
	value *GenerateDocumentRequest
	isSet bool
}

func (v NullableGenerateDocumentRequest) Get() *GenerateDocumentRequest {
	return v.value
}

func (v *NullableGenerateDocumentRequest) Set(val *GenerateDocumentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateDocumentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateDocumentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateDocumentRequest(val *GenerateDocumentRequest) *NullableGenerateDocumentRequest {
	return &NullableGenerateDocumentRequest{value: val, isSet: true}
}

func (v NullableGenerateDocumentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateDocumentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
