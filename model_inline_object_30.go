...
func (o *InlineObject30) GetMessage() string {
...
func (o *InlineObject30) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject30) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject30) SetMessage(v string) {
	o.Message = &v
}
