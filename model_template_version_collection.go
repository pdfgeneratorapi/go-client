...
// checks if the TemplateVersionCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateVersionCollection{}

// TemplateVersionCollection struct for TemplateVersionCollection
type TemplateVersionCollection struct {
	Response []TemplateVersion `json:"response,omitempty"`
	Meta *TemplateVersionCollectionMeta `json:"meta,omitempty"`
}
...
func NewTemplateVersionCollection() *TemplateVersionCollection {
	this := TemplateVersionCollection{}
	return &this
}
...
func (o *TemplateVersionCollection) GetMeta() TemplateVersionCollectionMeta {
	if o == nil || IsNil(o.Meta) {
		var ret TemplateVersionCollectionMeta
		return ret
	}
	return *o.Meta
}
...
// SetMeta gets a reference to the given TemplateVersionCollectionMeta and assigns it to the Meta field.
func (o *TemplateVersionCollection) SetMeta(v TemplateVersionCollectionMeta) {
	o.Meta = &v
}

func (o TemplateVersionCollection) MarshalJSON() ([]byte, error) {
...
func (o TemplateVersionCollection) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateVersionCollection struct {
	value *TemplateVersionCollection
	isSet bool
}

func (v NullableTemplateVersionCollection) Get() *TemplateVersionCollection {
	return v.value
}

func (v *NullableTemplateVersionCollection) Set(val *TemplateVersionCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateVersionCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateVersionCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateVersionCollection(val *TemplateVersionCollection) *NullableTemplateVersionCollection {
	return &NullableTemplateVersionCollection{value: val, isSet: true}
}

func (v NullableTemplateVersionCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateVersionCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
