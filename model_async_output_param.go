...
// AsyncOutputParam The generated document is returned as base64 string or URL which is stored for 30 days and automatically deleted.
type AsyncOutputParam string

// List of asyncOutputParam
const (
	ASYNCOUTPUTPARAM_BASE64 AsyncOutputParam = "base64"
	ASYNCOUTPUTPARAM_URL AsyncOutputParam = "url"
	ASYNCOUTPUTPARAM_VIEWER AsyncOutputParam = "viewer"
)

// All allowed values of AsyncOutputParam enum
var AllowedAsyncOutputParamEnumValues = []AsyncOutputParam{
	"base64",
	"url",
	"viewer",
}

func (v *AsyncOutputParam) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := AsyncOutputParam(value)
	for _, existing := range AllowedAsyncOutputParamEnumValues {
	...
	return fmt.Errorf("%+v is not a valid AsyncOutputParam", value)
}

// NewAsyncOutputParamFromValue returns a pointer to a valid AsyncOutputParam
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewAsyncOutputParamFromValue(v string) (*AsyncOutputParam, error) {
	ev := AsyncOutputParam(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for AsyncOutputParam: valid values are %v", v, AllowedAsyncOutputParamEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v AsyncOutputParam) IsValid() bool {
	for _, existing := range AllowedAsyncOutputParamEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to asyncOutputParam value
func (v AsyncOutputParam) Ptr() *AsyncOutputParam {
	return &v
}

type NullableAsyncOutputParam struct {
	value *AsyncOutputParam
	isSet bool
}

func (v NullableAsyncOutputParam) Get() *AsyncOutputParam {
	return v.value
}

func (v *NullableAsyncOutputParam) Set(val *AsyncOutputParam) {
	v.value = val
	v.isSet = true
}

func (v NullableAsyncOutputParam) IsSet() bool {
	return v.isSet
}

func (v *NullableAsyncOutputParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAsyncOutputParam(val *AsyncOutputParam) *NullableAsyncOutputParam {
	return &NullableAsyncOutputParam{value: val, isSet: true}
}

func (v NullableAsyncOutputParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAsyncOutputParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
