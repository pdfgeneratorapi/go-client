...
func (o *InlineObject2) GetResponse() map[string]interface{} {
...
func (o *InlineObject2) GetResponseOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Response) {
...
func (o *InlineObject2) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
func (o *InlineObject2) SetResponse(v map[string]interface{}) {
	o.Response = v
}
