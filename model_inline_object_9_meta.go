...
// InlineObject9Meta struct for InlineObject9Meta
...
func (o *InlineObject9Meta) GetName() string {
...
func (o *InlineObject9Meta) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *InlineObject9Meta) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InlineObject9Meta) SetName(v string) {
	o.Name = &v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *InlineObject9Meta) GetDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject9Meta) GetDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.DisplayName) {
		return nil, false
	}
...
func (o *InlineObject9Meta) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *InlineObject9Meta) SetDisplayName(v string) {
	o.DisplayName = &v
}

// GetEncoding returns the Encoding field value if set, zero value otherwise.
func (o *InlineObject9Meta) GetEncoding() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject9Meta) GetEncodingOk() (*string, bool) {
	if o == nil || IsNil(o.Encoding) {
		return nil, false
	}
...
func (o *InlineObject9Meta) HasEncoding() bool {
	if o != nil && !IsNil(o.Encoding) {
		return true
	}
...
func (o *InlineObject9Meta) SetEncoding(v string) {
	o.Encoding = &v
}

// GetContentType returns the ContentType field value if set, zero value otherwise.
func (o *InlineObject9Meta) GetContentType() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject9Meta) GetContentTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ContentType) {
		return nil, false
	}
...
func (o *InlineObject9Meta) HasContentType() bool {
	if o != nil && !IsNil(o.ContentType) {
		return true
	}
...
func (o *InlineObject9Meta) SetContentType(v string) {
	o.ContentType = &v
}

// GetPublicId returns the PublicId field value if set, zero value otherwise.
func (o *InlineObject9Meta) GetPublicId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineObject9Meta) GetPublicIdOk() (*string, bool) {
	if o == nil || IsNil(o.PublicId) {
		return nil, false
	}
...
func (o *InlineObject9Meta) HasPublicId() bool {
	if o != nil && !IsNil(o.PublicId) {
		return true
	}
...
func (o *InlineObject9Meta) SetPublicId(v string) {
	o.PublicId = &v
}
