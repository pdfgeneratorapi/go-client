...
// checks if the TemplateDefinitionEditor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDefinitionEditor{}
...
// NewTemplateDefinitionEditor instantiates a new TemplateDefinitionEditor object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateDefinitionEditor() *TemplateDefinitionEditor {
	this := TemplateDefinitionEditor{}
	return &this
}

// NewTemplateDefinitionEditorWithDefaults instantiates a new TemplateDefinitionEditor object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateDefinitionEditorWithDefaults() *TemplateDefinitionEditor {
	this := TemplateDefinitionEditor{}
	return &this
}

// GetHeightMultiplier returns the HeightMultiplier field value if set, zero value otherwise.
func (o *TemplateDefinitionEditor) GetHeightMultiplier() float32 {
...
func (o *TemplateDefinitionEditor) GetHeightMultiplierOk() (*float32, bool) {
	if o == nil || IsNil(o.HeightMultiplier) {
		return nil, false
	}
...
func (o *TemplateDefinitionEditor) HasHeightMultiplier() bool {
	if o != nil && !IsNil(o.HeightMultiplier) {
		return true
	}
...
func (o *TemplateDefinitionEditor) SetHeightMultiplier(v float32) {
	o.HeightMultiplier = &v
}

func (o TemplateDefinitionEditor) MarshalJSON() ([]byte, error) {
...
func (o TemplateDefinitionEditor) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateDefinitionEditor struct {
	value *TemplateDefinitionEditor
	isSet bool
}

func (v NullableTemplateDefinitionEditor) Get() *TemplateDefinitionEditor {
	return v.value
}

func (v *NullableTemplateDefinitionEditor) Set(val *TemplateDefinitionEditor) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDefinitionEditor) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDefinitionEditor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDefinitionEditor(val *TemplateDefinitionEditor) *NullableTemplateDefinitionEditor {
	return &NullableTemplateDefinitionEditor{value: val, isSet: true}
}

func (v NullableTemplateDefinitionEditor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDefinitionEditor) UnmarshalJSON(src []byte) error {
	v.isSet = true
