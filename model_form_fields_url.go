...
// checks if the FormFieldsUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormFieldsUrl{}

// FormFieldsUrl struct for FormFieldsUrl
type FormFieldsUrl struct {
	// Public URL to a PDF document
	FileUrl string `json:"file_url"`
	KeyField *KeyFieldParam `json:"key_field,omitempty"`
}

type _FormFieldsUrl FormFieldsUrl
...
func (o FormFieldsUrl) MarshalJSON() ([]byte, error) {
...
func (o FormFieldsUrl) ToMap() (map[string]interface{}, error) {
...
func (o *FormFieldsUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varFormFieldsUrl := _FormFieldsUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormFieldsUrl)

	if err != nil {
		return err
	}

	*o = FormFieldsUrl(varFormFieldsUrl)

	return err
}

type NullableFormFieldsUrl struct {
	value *FormFieldsUrl
	isSet bool
}

func (v NullableFormFieldsUrl) Get() *FormFieldsUrl {
	return v.value
}

func (v *NullableFormFieldsUrl) Set(val *FormFieldsUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableFormFieldsUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableFormFieldsUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormFieldsUrl(val *FormFieldsUrl) *NullableFormFieldsUrl {
	return &NullableFormFieldsUrl{value: val, isSet: true}
}

func (v NullableFormFieldsUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormFieldsUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
