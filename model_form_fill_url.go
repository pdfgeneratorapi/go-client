...
// checks if the FormFillUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormFillUrl{}

// FormFillUrl struct for FormFillUrl
type FormFillUrl struct {
...
func (o FormFillUrl) MarshalJSON() ([]byte, error) {
...
func (o FormFillUrl) ToMap() (map[string]interface{}, error) {
...
func (o *FormFillUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varFormFillUrl := _FormFillUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormFillUrl)

	if err != nil {
		return err
	}

	*o = FormFillUrl(varFormFillUrl)

	return err
}

type NullableFormFillUrl struct {
	value *FormFillUrl
	isSet bool
}

func (v NullableFormFillUrl) Get() *FormFillUrl {
	return v.value
}

func (v *NullableFormFillUrl) Set(val *FormFillUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableFormFillUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableFormFillUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormFillUrl(val *FormFillUrl) *NullableFormFillUrl {
	return &NullableFormFillUrl{value: val, isSet: true}
}

func (v NullableFormFillUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormFillUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
