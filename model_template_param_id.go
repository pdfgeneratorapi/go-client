...
// TemplateParamId - Template ID or Public template ID
type TemplateParamId struct {
	Int32 *int32
	String *string
}

// int32AsTemplateParamId is a convenience function that returns int32 wrapped in TemplateParamId
func Int32AsTemplateParamId(v *int32) TemplateParamId {
	return TemplateParamId{
		Int32: v,
	}
}

// stringAsTemplateParamId is a convenience function that returns string wrapped in TemplateParamId
func StringAsTemplateParamId(v *string) TemplateParamId {
	return TemplateParamId{
		String: v,
	}
}
...
func (dst *TemplateParamId) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TemplateParamId)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TemplateParamId)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TemplateParamId) MarshalJSON() ([]byte, error) {
	if src.Int32 != nil {
...
func (obj *TemplateParamId) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Int32 != nil {
...
func (obj TemplateParamId) GetActualInstanceValue() (interface{}) {
	if obj.Int32 != nil {
		return *obj.Int32
	}
...
type NullableTemplateParamId struct {
	value *TemplateParamId
	isSet bool
}

func (v NullableTemplateParamId) Get() *TemplateParamId {
	return v.value
}

func (v *NullableTemplateParamId) Set(val *TemplateParamId) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateParamId) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateParamId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateParamId(val *TemplateParamId) *NullableTemplateParamId {
	return &NullableTemplateParamId{value: val, isSet: true}
}

func (v NullableTemplateParamId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateParamId) UnmarshalJSON(src []byte) error {
	v.isSet = true
