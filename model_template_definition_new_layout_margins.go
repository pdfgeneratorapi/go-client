...
// checks if the TemplateDefinitionNewLayoutMargins type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateDefinitionNewLayoutMargins{}
...
// NewTemplateDefinitionNewLayoutMargins instantiates a new TemplateDefinitionNewLayoutMargins object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateDefinitionNewLayoutMargins() *TemplateDefinitionNewLayoutMargins {
	this := TemplateDefinitionNewLayoutMargins{}
	return &this
}

// NewTemplateDefinitionNewLayoutMarginsWithDefaults instantiates a new TemplateDefinitionNewLayoutMargins object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateDefinitionNewLayoutMarginsWithDefaults() *TemplateDefinitionNewLayoutMargins {
	this := TemplateDefinitionNewLayoutMargins{}
	return &this
}

// GetTop returns the Top field value if set, zero value otherwise.
func (o *TemplateDefinitionNewLayoutMargins) GetTop() float32 {
...
func (o *TemplateDefinitionNewLayoutMargins) GetTopOk() (*float32, bool) {
	if o == nil || IsNil(o.Top) {
		return nil, false
	}
	return o.Top, true
...
func (o *TemplateDefinitionNewLayoutMargins) HasTop() bool {
	if o != nil && !IsNil(o.Top) {
		return true
	}
...
func (o *TemplateDefinitionNewLayoutMargins) SetTop(v float32) {
	o.Top = &v
}

// GetRight returns the Right field value if set, zero value otherwise.
func (o *TemplateDefinitionNewLayoutMargins) GetRight() float32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionNewLayoutMargins) GetRightOk() (*float32, bool) {
	if o == nil || IsNil(o.Right) {
		return nil, false
	}
	return o.Right, true
...
func (o *TemplateDefinitionNewLayoutMargins) HasRight() bool {
	if o != nil && !IsNil(o.Right) {
		return true
	}
...
func (o *TemplateDefinitionNewLayoutMargins) SetRight(v float32) {
	o.Right = &v
}

// GetBottom returns the Bottom field value if set, zero value otherwise.
func (o *TemplateDefinitionNewLayoutMargins) GetBottom() float32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionNewLayoutMargins) GetBottomOk() (*float32, bool) {
	if o == nil || IsNil(o.Bottom) {
		return nil, false
	}
...
func (o *TemplateDefinitionNewLayoutMargins) HasBottom() bool {
	if o != nil && !IsNil(o.Bottom) {
		return true
	}
...
func (o *TemplateDefinitionNewLayoutMargins) SetBottom(v float32) {
	o.Bottom = &v
}

// GetLeft returns the Left field value if set, zero value otherwise.
func (o *TemplateDefinitionNewLayoutMargins) GetLeft() float32 {
...
// and a boolean to check if the value has been set.
func (o *TemplateDefinitionNewLayoutMargins) GetLeftOk() (*float32, bool) {
	if o == nil || IsNil(o.Left) {
		return nil, false
	}
	return o.Left, true
...
func (o *TemplateDefinitionNewLayoutMargins) HasLeft() bool {
	if o != nil && !IsNil(o.Left) {
		return true
	}
...
func (o *TemplateDefinitionNewLayoutMargins) SetLeft(v float32) {
	o.Left = &v
}

func (o TemplateDefinitionNewLayoutMargins) MarshalJSON() ([]byte, error) {
...
func (o TemplateDefinitionNewLayoutMargins) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateDefinitionNewLayoutMargins struct {
	value *TemplateDefinitionNewLayoutMargins
	isSet bool
}

func (v NullableTemplateDefinitionNewLayoutMargins) Get() *TemplateDefinitionNewLayoutMargins {
	return v.value
}

func (v *NullableTemplateDefinitionNewLayoutMargins) Set(val *TemplateDefinitionNewLayoutMargins) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDefinitionNewLayoutMargins) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDefinitionNewLayoutMargins) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDefinitionNewLayoutMargins(val *TemplateDefinitionNewLayoutMargins) *NullableTemplateDefinitionNewLayoutMargins {
	return &NullableTemplateDefinitionNewLayoutMargins{value: val, isSet: true}
}

func (v NullableTemplateDefinitionNewLayoutMargins) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDefinitionNewLayoutMargins) UnmarshalJSON(src []byte) error {
	v.isSet = true
