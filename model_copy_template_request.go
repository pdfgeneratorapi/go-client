...
// checks if the CopyTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyTemplateRequest{}
...
func (o CopyTemplateRequest) ToMap() (map[string]interface{}, error) {
