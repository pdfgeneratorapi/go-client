...
func (o *InlineObject31) GetMessage() string {
...
func (o *InlineObject31) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject31) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject31) SetMessage(v string) {
	o.Message = &v
}
