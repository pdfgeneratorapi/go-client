...
// List of watermarkPosition
const (
	WATERMARKPOSITION_TOP_LEFT WatermarkPosition = "top-left"
	WATERMARKPOSITION_TOP_CENTER WatermarkPosition = "top-center"
	WATERMARKPOSITION_TOP_RIGHT WatermarkPosition = "top-right"
	WATERMARKPOSITION_LEFT WatermarkPosition = "left"
	WATERMARKPOSITION_CENTER WatermarkPosition = "center"
	WATERMARKPOSITION_RIGHT WatermarkPosition = "right"
	WATERMARKPOSITION_BOTTOM_LEFT WatermarkPosition = "bottom-left"
	WATERMARKPOSITION_BOTTOM_CENTER WatermarkPosition = "bottom-center"
	WATERMARKPOSITION_BOTTOM_RIGHT WatermarkPosition = "bottom-right"
)

// All allowed values of WatermarkPosition enum
var AllowedWatermarkPositionEnumValues = []WatermarkPosition{
	"top-left",
	"top-center",
	"top-right",
	"left",
...
func (v *WatermarkPosition) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := WatermarkPosition(value)
	for _, existing := range AllowedWatermarkPositionEnumValues {
	...
	return fmt.Errorf("%+v is not a valid WatermarkPosition", value)
}

// NewWatermarkPositionFromValue returns a pointer to a valid WatermarkPosition
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewWatermarkPositionFromValue(v string) (*WatermarkPosition, error) {
	ev := WatermarkPosition(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for WatermarkPosition: valid values are %v", v, AllowedWatermarkPositionEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v WatermarkPosition) IsValid() bool {
	for _, existing := range AllowedWatermarkPositionEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to watermarkPosition value
func (v WatermarkPosition) Ptr() *WatermarkPosition {
	return &v
}

type NullableWatermarkPosition struct {
	value *WatermarkPosition
	isSet bool
}

func (v NullableWatermarkPosition) Get() *WatermarkPosition {
	return v.value
}

func (v *NullableWatermarkPosition) Set(val *WatermarkPosition) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkPosition) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkPosition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkPosition(val *WatermarkPosition) *NullableWatermarkPosition {
	return &NullableWatermarkPosition{value: val, isSet: true}
}

func (v NullableWatermarkPosition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkPosition) UnmarshalJSON(src []byte) error {
	v.isSet = true
