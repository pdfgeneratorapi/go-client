...
// checks if the PromoteTemplateVersion200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromoteTemplateVersion200Response{}

// PromoteTemplateVersion200Response struct for PromoteTemplateVersion200Response
type PromoteTemplateVersion200Response struct {
	Response *TemplateVersion `json:"response,omitempty"`
}

// NewPromoteTemplateVersion200Response instantiates a new PromoteTemplateVersion200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPromoteTemplateVersion200Response() *PromoteTemplateVersion200Response {
	this := PromoteTemplateVersion200Response{}
	return &this
}

// NewPromoteTemplateVersion200ResponseWithDefaults instantiates a new PromoteTemplateVersion200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPromoteTemplateVersion200ResponseWithDefaults() *PromoteTemplateVersion200Response {
	this := PromoteTemplateVersion200Response{}
	return &this
}

// GetResponse returns the Response field value if set, zero value otherwise.
func (o *PromoteTemplateVersion200Response) GetResponse() TemplateVersion {
...
func (o *PromoteTemplateVersion200Response) GetResponseOk() (*TemplateVersion, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *PromoteTemplateVersion200Response) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given TemplateVersion and assigns it to the Response field.
func (o *PromoteTemplateVersion200Response) SetResponse(v TemplateVersion) {
	o.Response = &v
}

func (o PromoteTemplateVersion200Response) MarshalJSON() ([]byte, error) {
...
func (o PromoteTemplateVersion200Response) ToMap() (map[string]interface{}, error) {
...
type NullablePromoteTemplateVersion200Response struct {
	value *PromoteTemplateVersion200Response
	isSet bool
}

func (v NullablePromoteTemplateVersion200Response) Get() *PromoteTemplateVersion200Response {
	return v.value
}

func (v *NullablePromoteTemplateVersion200Response) Set(val *PromoteTemplateVersion200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePromoteTemplateVersion200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePromoteTemplateVersion200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromoteTemplateVersion200Response(val *PromoteTemplateVersion200Response) *NullablePromoteTemplateVersion200Response {
	return &NullablePromoteTemplateVersion200Response{value: val, isSet: true}
}

func (v NullablePromoteTemplateVersion200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromoteTemplateVersion200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
