...
// checks if the OptimizeUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptimizeUrl{}

// OptimizeUrl struct for OptimizeUrl
type OptimizeUrl struct {
...
func (o OptimizeUrl) MarshalJSON() ([]byte, error) {
...
func (o OptimizeUrl) ToMap() (map[string]interface{}, error) {
...
func (o *OptimizeUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varOptimizeUrl := _OptimizeUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOptimizeUrl)

	if err != nil {
		return err
	}

	*o = OptimizeUrl(varOptimizeUrl)

	return err
}

type NullableOptimizeUrl struct {
	value *OptimizeUrl
	isSet bool
}

func (v NullableOptimizeUrl) Get() *OptimizeUrl {
	return v.value
}

func (v *NullableOptimizeUrl) Set(val *OptimizeUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableOptimizeUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableOptimizeUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptimizeUrl(val *OptimizeUrl) *NullableOptimizeUrl {
	return &NullableOptimizeUrl{value: val, isSet: true}
}

func (v NullableOptimizeUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptimizeUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
