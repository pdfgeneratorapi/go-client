...
// checks if the ImportTemplateUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportTemplateUrl{}

// ImportTemplateUrl struct for ImportTemplateUrl
type ImportTemplateUrl struct {
	Template ImportTemplateUrlTemplate `json:"template"`
	// PDF file from remote URL to import
	FileUrl string `json:"file_url"`
}

type _ImportTemplateUrl ImportTemplateUrl
...
func (o ImportTemplateUrl) MarshalJSON() ([]byte, error) {
...
func (o ImportTemplateUrl) ToMap() (map[string]interface{}, error) {
...
func (o *ImportTemplateUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varImportTemplateUrl := _ImportTemplateUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportTemplateUrl)

	if err != nil {
		return err
	}

	*o = ImportTemplateUrl(varImportTemplateUrl)

	return err
}

type NullableImportTemplateUrl struct {
	value *ImportTemplateUrl
	isSet bool
}

func (v NullableImportTemplateUrl) Get() *ImportTemplateUrl {
	return v.value
}

func (v *NullableImportTemplateUrl) Set(val *ImportTemplateUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableImportTemplateUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableImportTemplateUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportTemplateUrl(val *ImportTemplateUrl) *NullableImportTemplateUrl {
	return &NullableImportTemplateUrl{value: val, isSet: true}
}

func (v NullableImportTemplateUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportTemplateUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
