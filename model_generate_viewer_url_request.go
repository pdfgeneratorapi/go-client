...
// checks if the GenerateViewerUrlRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateViewerUrlRequest{}

// GenerateViewerUrlRequest struct for GenerateViewerUrlRequest
type GenerateViewerUrlRequest struct {
	...
	Prefill *PrefillParam `json:"prefill,omitempty"`
}
...
// SetPrefill gets a reference to the given PrefillParam and assigns it to the Prefill field.
func (o *GenerateViewerUrlRequest) SetPrefill(v PrefillParam) {
	o.Prefill = &v
}

func (o GenerateViewerUrlRequest) MarshalJSON() ([]byte, error) {
...
func (o GenerateViewerUrlRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGenerateViewerUrlRequest struct {
	value *GenerateViewerUrlRequest
	isSet bool
}

func (v NullableGenerateViewerUrlRequest) Get() *GenerateViewerUrlRequest {
	return v.value
}

func (v *NullableGenerateViewerUrlRequest) Set(val *GenerateViewerUrlRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateViewerUrlRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateViewerUrlRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateViewerUrlRequest(val *GenerateViewerUrlRequest) *NullableGenerateViewerUrlRequest {
	return &NullableGenerateViewerUrlRequest{value: val, isSet: true}
}

func (v NullableGenerateViewerUrlRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateViewerUrlRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
