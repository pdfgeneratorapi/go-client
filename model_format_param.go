...
// FormatParam Document format.
type FormatParam string

// List of formatParam
const (
	FORMATPARAM_PDF FormatParam = "pdf"
	FORMATPARAM_HTML FormatParam = "html"
)

// All allowed values of FormatParam enum
var AllowedFormatParamEnumValues = []FormatParam{
	"pdf",
	"html",
}

func (v *FormatParam) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := FormatParam(value)
	for _, existing := range AllowedFormatParamEnumValues {
	...
	return fmt.Errorf("%+v is not a valid FormatParam", value)
}

// NewFormatParamFromValue returns a pointer to a valid FormatParam
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewFormatParamFromValue(v string) (*FormatParam, error) {
	ev := FormatParam(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for FormatParam: valid values are %v", v, AllowedFormatParamEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v FormatParam) IsValid() bool {
	for _, existing := range AllowedFormatParamEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to formatParam value
func (v FormatParam) Ptr() *FormatParam {
	return &v
}

type NullableFormatParam struct {
	value *FormatParam
	isSet bool
}

func (v NullableFormatParam) Get() *FormatParam {
	return v.value
}

func (v *NullableFormatParam) Set(val *FormatParam) {
	v.value = val
	v.isSet = true
}

func (v NullableFormatParam) IsSet() bool {
	return v.isSet
}

func (v *NullableFormatParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormatParam(val *FormatParam) *NullableFormatParam {
	return &NullableFormatParam{value: val, isSet: true}
}

func (v NullableFormatParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormatParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
