...
// checks if the InlineObject20Meta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject20Meta{}

// InlineObject20Meta struct for InlineObject20Meta
type InlineObject20Meta struct {
...
func (o InlineObject20Meta) MarshalJSON() ([]byte, error) {
...
func (o InlineObject20Meta) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject20Meta struct {
	value *InlineObject20Meta
	isSet bool
}

func (v NullableInlineObject20Meta) Get() *InlineObject20Meta {
	return v.value
}

func (v *NullableInlineObject20Meta) Set(val *InlineObject20Meta) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject20Meta) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject20Meta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject20Meta(val *InlineObject20Meta) *NullableInlineObject20Meta {
	return &NullableInlineObject20Meta{value: val, isSet: true}
}

func (v NullableInlineObject20Meta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject20Meta) UnmarshalJSON(src []byte) error {
	v.isSet = true
