...
// checks if the TemplateParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateParam{}

// TemplateParam Template id, version, version id and data
type TemplateParam struct {
	Id *TemplateParamId `json:"id,omitempty"`
	// Template version ID
	VersionId *int32 `json:"version_id,omitempty"`
	Data *TemplateParamData `json:"data,omitempty"`
}
...
// SetId gets a reference to the given TemplateParamId and assigns it to the Id field.
...
// SetData gets a reference to the given TemplateParamData and assigns it to the Data field.
func (o *TemplateParam) SetData(v TemplateParamData) {
	o.Data = &v
}

func (o TemplateParam) MarshalJSON() ([]byte, error) {
...
func (o TemplateParam) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateParam struct {
	value *TemplateParam
	isSet bool
}

func (v NullableTemplateParam) Get() *TemplateParam {
	return v.value
}

func (v *NullableTemplateParam) Set(val *TemplateParam) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateParam) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateParam(val *TemplateParam) *NullableTemplateParam {
	return &NullableTemplateParam{value: val, isSet: true}
}

func (v NullableTemplateParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
