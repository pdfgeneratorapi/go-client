...
// checks if the FormConfigurationNew type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormConfigurationNew{}

// FormConfigurationNew struct for FormConfigurationNew
type FormConfigurationNew struct {
	// Template ID which is connected to the form
	TemplateId *int32 `json:"template_id,omitempty"`
	// Form name
	Name *string `json:"name,omitempty"`
	// Array of action configurations
	Actions []FormConfigurationNewActionsInner `json:"actions,omitempty"`
	// A list of form field objects
	Fields []FormFieldsInner `json:"fields,omitempty"`
...
func (o *FormConfigurationNew) GetActions() []FormConfigurationNewActionsInner {
	if o == nil || IsNil(o.Actions) {
		var ret []FormConfigurationNewActionsInner
		return ret
	}
	return o.Actions
}
...
// SetActions gets a reference to the given []FormConfigurationNewActionsInner and assigns it to the Actions field.
...
// SetFields gets a reference to the given []FormFieldsInner and assigns it to the Fields field.
...
// SetConfiguration gets a reference to the given FormConfiguration and assigns it to the Configuration field.
func (o *FormConfigurationNew) SetConfiguration(v FormConfiguration) {
	o.Configuration = &v
}

func (o FormConfigurationNew) MarshalJSON() ([]byte, error) {
...
func (o FormConfigurationNew) ToMap() (map[string]interface{}, error) {
...
type NullableFormConfigurationNew struct {
	value *FormConfigurationNew
	isSet bool
}

func (v NullableFormConfigurationNew) Get() *FormConfigurationNew {
	return v.value
}

func (v *NullableFormConfigurationNew) Set(val *FormConfigurationNew) {
	v.value = val
	v.isSet = true
}

func (v NullableFormConfigurationNew) IsSet() bool {
	return v.isSet
}

func (v *NullableFormConfigurationNew) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormConfigurationNew(val *FormConfigurationNew) *NullableFormConfigurationNew {
	return &NullableFormConfigurationNew{value: val, isSet: true}
}

func (v NullableFormConfigurationNew) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormConfigurationNew) UnmarshalJSON(src []byte) error {
	v.isSet = true
