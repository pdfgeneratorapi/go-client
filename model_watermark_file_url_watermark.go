...
// checks if the WatermarkFileUrlWatermark type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatermarkFileUrlWatermark{}

// WatermarkFileUrlWatermark struct for WatermarkFileUrlWatermark
type WatermarkFileUrlWatermark struct {
	Image *WatermarkImage `json:"image,omitempty"`
	Text *WatermarkText `json:"text,omitempty"`
}

// NewWatermarkFileUrlWatermark instantiates a new WatermarkFileUrlWatermark object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWatermarkFileUrlWatermark() *WatermarkFileUrlWatermark {
	this := WatermarkFileUrlWatermark{}
	return &this
}

// NewWatermarkFileUrlWatermarkWithDefaults instantiates a new WatermarkFileUrlWatermark object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWatermarkFileUrlWatermarkWithDefaults() *WatermarkFileUrlWatermark {
	this := WatermarkFileUrlWatermark{}
	return &this
}

// GetImage returns the Image field value if set, zero value otherwise.
func (o *WatermarkFileUrlWatermark) GetImage() WatermarkImage {
	if o == nil || IsNil(o.Image) {
		var ret WatermarkImage
		return ret
	}
	return *o.Image
}
...
func (o *WatermarkFileUrlWatermark) GetImageOk() (*WatermarkImage, bool) {
	if o == nil || IsNil(o.Image) {
		return nil, false
	}
	return o.Image, true
...
func (o *WatermarkFileUrlWatermark) HasImage() bool {
	if o != nil && !IsNil(o.Image) {
		return true
	}
...
// SetImage gets a reference to the given WatermarkImage and assigns it to the Image field.
func (o *WatermarkFileUrlWatermark) SetImage(v WatermarkImage) {
	o.Image = &v
}

// GetText returns the Text field value if set, zero value otherwise.
func (o *WatermarkFileUrlWatermark) GetText() WatermarkText {
	if o == nil || IsNil(o.Text) {
		var ret WatermarkText
		return ret
	}
	return *o.Text
}
...
// and a boolean to check if the value has been set.
func (o *WatermarkFileUrlWatermark) GetTextOk() (*WatermarkText, bool) {
	if o == nil || IsNil(o.Text) {
		return nil, false
	}
	return o.Text, true
...
func (o *WatermarkFileUrlWatermark) HasText() bool {
	if o != nil && !IsNil(o.Text) {
		return true
	}
...
// SetText gets a reference to the given WatermarkText and assigns it to the Text field.
func (o *WatermarkFileUrlWatermark) SetText(v WatermarkText) {
	o.Text = &v
}

func (o WatermarkFileUrlWatermark) MarshalJSON() ([]byte, error) {
...
func (o WatermarkFileUrlWatermark) ToMap() (map[string]interface{}, error) {
...
type NullableWatermarkFileUrlWatermark struct {
	value *WatermarkFileUrlWatermark
	isSet bool
}

func (v NullableWatermarkFileUrlWatermark) Get() *WatermarkFileUrlWatermark {
	return v.value
}

func (v *NullableWatermarkFileUrlWatermark) Set(val *WatermarkFileUrlWatermark) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkFileUrlWatermark) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkFileUrlWatermark) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkFileUrlWatermark(val *WatermarkFileUrlWatermark) *NullableWatermarkFileUrlWatermark {
	return &NullableWatermarkFileUrlWatermark{value: val, isSet: true}
}

func (v NullableWatermarkFileUrlWatermark) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkFileUrlWatermark) UnmarshalJSON(src []byte) error {
	v.isSet = true
