...
// StatusParam the model 'StatusParam'
type StatusParam string

// List of statusParam
const (
	STATUSPARAM_OK StatusParam = "ok"
	STATUSPARAM_FAILED StatusParam = "failed"
)

// All allowed values of StatusParam enum
var AllowedStatusParamEnumValues = []StatusParam{
	"ok",
	"failed",
}

func (v *StatusParam) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := StatusParam(value)
	for _, existing := range AllowedStatusParamEnumValues {
	...
	return fmt.Errorf("%+v is not a valid StatusParam", value)
}

// NewStatusParamFromValue returns a pointer to a valid StatusParam
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewStatusParamFromValue(v string) (*StatusParam, error) {
	ev := StatusParam(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for StatusParam: valid values are %v", v, AllowedStatusParamEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v StatusParam) IsValid() bool {
	for _, existing := range AllowedStatusParamEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to statusParam value
func (v StatusParam) Ptr() *StatusParam {
	return &v
}

type NullableStatusParam struct {
	value *StatusParam
	isSet bool
}

func (v NullableStatusParam) Get() *StatusParam {
	return v.value
}

func (v *NullableStatusParam) Set(val *StatusParam) {
	v.value = val
	v.isSet = true
}

func (v NullableStatusParam) IsSet() bool {
	return v.isSet
}

func (v *NullableStatusParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatusParam(val *StatusParam) *NullableStatusParam {
	return &NullableStatusParam{value: val, isSet: true}
}

func (v NullableStatusParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatusParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
