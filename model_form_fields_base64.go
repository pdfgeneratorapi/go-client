...
// checks if the FormFieldsBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormFieldsBase64{}

// FormFieldsBase64 struct for FormFieldsBase64
type FormFieldsBase64 struct {
	// PDF document in base64 encoded string format
	FileBase64 string `json:"file_base64"`
	KeyField *KeyFieldParam `json:"key_field,omitempty"`
}

type _FormFieldsBase64 FormFieldsBase64
...
func NewFormFieldsBase64(fileBase64 string) *FormFieldsBase64 {
	this := FormFieldsBase64{}
	this.FileBase64 = fileBase64
	var keyField KeyFieldParam = KEYFIELDPARAM_NAME
...
// SetKeyField gets a reference to the given KeyFieldParam and assigns it to the KeyField field.
func (o *FormFieldsBase64) SetKeyField(v KeyFieldParam) {
	o.KeyField = &v
}

func (o FormFieldsBase64) MarshalJSON() ([]byte, error) {
...
func (o FormFieldsBase64) ToMap() (map[string]interface{}, error) {
...
func (o *FormFieldsBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varFormFieldsBase64 := _FormFieldsBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormFieldsBase64)

	if err != nil {
		return err
	}

	*o = FormFieldsBase64(varFormFieldsBase64)

	return err
}

type NullableFormFieldsBase64 struct {
	value *FormFieldsBase64
	isSet bool
}

func (v NullableFormFieldsBase64) Get() *FormFieldsBase64 {
	return v.value
}

func (v *NullableFormFieldsBase64) Set(val *FormFieldsBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableFormFieldsBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableFormFieldsBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormFieldsBase64(val *FormFieldsBase64) *NullableFormFieldsBase64 {
	return &NullableFormFieldsBase64{value: val, isSet: true}
}

func (v NullableFormFieldsBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormFieldsBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
