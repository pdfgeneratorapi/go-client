...
// checks if the EncryptAndDecryptBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncryptAndDecryptBase64{}

// EncryptAndDecryptBase64 struct for EncryptAndDecryptBase64
type EncryptAndDecryptBase64 struct {
...
type _EncryptAndDecryptBase64 EncryptAndDecryptBase64
...
func (o EncryptAndDecryptBase64) MarshalJSON() ([]byte, error) {
...
func (o EncryptAndDecryptBase64) ToMap() (map[string]interface{}, error) {
...
func (o *EncryptAndDecryptBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varEncryptAndDecryptBase64 := _EncryptAndDecryptBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEncryptAndDecryptBase64)

	if err != nil {
		return err
	}

	*o = EncryptAndDecryptBase64(varEncryptAndDecryptBase64)

	return err
}

type NullableEncryptAndDecryptBase64 struct {
	value *EncryptAndDecryptBase64
	isSet bool
}

func (v NullableEncryptAndDecryptBase64) Get() *EncryptAndDecryptBase64 {
	return v.value
}

func (v *NullableEncryptAndDecryptBase64) Set(val *EncryptAndDecryptBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableEncryptAndDecryptBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableEncryptAndDecryptBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncryptAndDecryptBase64(val *EncryptAndDecryptBase64) *NullableEncryptAndDecryptBase64 {
	return &NullableEncryptAndDecryptBase64{value: val, isSet: true}
}

func (v NullableEncryptAndDecryptBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncryptAndDecryptBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
