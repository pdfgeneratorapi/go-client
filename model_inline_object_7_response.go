...
// checks if the InlineObject7Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject7Response{}

// InlineObject7Response struct for InlineObject7Response
type InlineObject7Response struct {
	Success *bool `json:"success,omitempty"`
}

// NewInlineObject7Response instantiates a new InlineObject7Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineObject7Response() *InlineObject7Response {
	this := InlineObject7Response{}
	return &this
}

// NewInlineObject7ResponseWithDefaults instantiates a new InlineObject7Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineObject7ResponseWithDefaults() *InlineObject7Response {
	this := InlineObject7Response{}
	return &this
}

// GetSuccess returns the Success field value if set, zero value otherwise.
func (o *InlineObject7Response) GetSuccess() bool {
...
func (o *InlineObject7Response) GetSuccessOk() (*bool, bool) {
	if o == nil || IsNil(o.Success) {
		return nil, false
	}
...
func (o *InlineObject7Response) HasSuccess() bool {
	if o != nil && !IsNil(o.Success) {
		return true
	}
...
func (o *InlineObject7Response) SetSuccess(v bool) {
	o.Success = &v
}

func (o InlineObject7Response) MarshalJSON() ([]byte, error) {
...
func (o InlineObject7Response) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject7Response struct {
	value *InlineObject7Response
	isSet bool
}

func (v NullableInlineObject7Response) Get() *InlineObject7Response {
	return v.value
}

func (v *NullableInlineObject7Response) Set(val *InlineObject7Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject7Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject7Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject7Response(val *InlineObject7Response) *NullableInlineObject7Response {
	return &NullableInlineObject7Response{value: val, isSet: true}
}

func (v NullableInlineObject7Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject7Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
