...
// AccessibilityOption the model 'AccessibilityOption'
type AccessibilityOption string

// List of AccessibilityOption
const (
	ACCESSIBILITYOPTION_CLEAR_STRUCTURE AccessibilityOption = "clear_structure"
	ACCESSIBILITYOPTION_CLEAR_BOOKMARKS AccessibilityOption = "clear_bookmarks"
	ACCESSIBILITYOPTION_EMBED_FONT AccessibilityOption = "embed_font"
	ACCESSIBILITYOPTION_ADD_MISSING_UNICODE AccessibilityOption = "add_missing_unicode"
	ACCESSIBILITYOPTION_ADD_TAGS AccessibilityOption = "add_tags"
	ACCESSIBILITYOPTION_SET_LANGUAGE AccessibilityOption = "set_language"
	ACCESSIBILITYOPTION_SET_TITLE AccessibilityOption = "set_title"
	ACCESSIBILITYOPTION_SET_DISPLAY_DOC_TITLE AccessibilityOption = "set_display_doc_title"
	ACCESSIBILITYOPTION_SET_PDF_UA_STANDARD AccessibilityOption = "set_pdf_ua_standard"
)

// All allowed values of AccessibilityOption enum
var AllowedAccessibilityOptionEnumValues = []AccessibilityOption{
	"clear_structure",
	"clear_bookmarks",
	"embed_font",
	"add_missing_unicode",
...
func (v *AccessibilityOption) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := AccessibilityOption(value)
	for _, existing := range AllowedAccessibilityOptionEnumValues {
	...
	return fmt.Errorf("%+v is not a valid AccessibilityOption", value)
}

// NewAccessibilityOptionFromValue returns a pointer to a valid AccessibilityOption
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewAccessibilityOptionFromValue(v string) (*AccessibilityOption, error) {
	ev := AccessibilityOption(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for AccessibilityOption: valid values are %v", v, AllowedAccessibilityOptionEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v AccessibilityOption) IsValid() bool {
	for _, existing := range AllowedAccessibilityOptionEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to AccessibilityOption value
func (v AccessibilityOption) Ptr() *AccessibilityOption {
	return &v
}

type NullableAccessibilityOption struct {
	value *AccessibilityOption
	isSet bool
}

func (v NullableAccessibilityOption) Get() *AccessibilityOption {
	return v.value
}

func (v *NullableAccessibilityOption) Set(val *AccessibilityOption) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessibilityOption) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessibilityOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessibilityOption(val *AccessibilityOption) *NullableAccessibilityOption {
	return &NullableAccessibilityOption{value: val, isSet: true}
}

func (v NullableAccessibilityOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessibilityOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
