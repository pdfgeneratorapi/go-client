...
// checks if the FormActionDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormActionDownload{}

// FormActionDownload Key-value pair of action configuration.
type FormActionDownload struct {
	DownloadDocument *bool `json:"download_document,omitempty"`
}

// NewFormActionDownload instantiates a new FormActionDownload object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFormActionDownload() *FormActionDownload {
	this := FormActionDownload{}
	return &this
}

// NewFormActionDownloadWithDefaults instantiates a new FormActionDownload object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFormActionDownloadWithDefaults() *FormActionDownload {
	this := FormActionDownload{}
	return &this
}

// GetDownloadDocument returns the DownloadDocument field value if set, zero value otherwise.
func (o *FormActionDownload) GetDownloadDocument() bool {
	if o == nil || IsNil(o.DownloadDocument) {
		var ret bool
		return ret
	}
	return *o.DownloadDocument
}

// GetDownloadDocumentOk returns a tuple with the DownloadDocument field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FormActionDownload) GetDownloadDocumentOk() (*bool, bool) {
	if o == nil || IsNil(o.DownloadDocument) {
		return nil, false
	}
	return o.DownloadDocument, true
}

// HasDownloadDocument returns a boolean if a field has been set.
func (o *FormActionDownload) HasDownloadDocument() bool {
	if o != nil && !IsNil(o.DownloadDocument) {
		return true
	}
...
// SetDownloadDocument gets a reference to the given bool and assigns it to the DownloadDocument field.
func (o *FormActionDownload) SetDownloadDocument(v bool) {
	o.DownloadDocument = &v
}

func (o FormActionDownload) MarshalJSON() ([]byte, error) {
...
func (o FormActionDownload) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DownloadDocument) {
		toSerialize["download_document"] = o.DownloadDocument
	}
	return toSerialize, nil
}

type NullableFormActionDownload struct {
	value *FormActionDownload
	isSet bool
}

func (v NullableFormActionDownload) Get() *FormActionDownload {
	return v.value
}

func (v *NullableFormActionDownload) Set(val *FormActionDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableFormActionDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableFormActionDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormActionDownload(val *FormActionDownload) *NullableFormActionDownload {
	return &NullableFormActionDownload{value: val, isSet: true}
}

func (v NullableFormActionDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormActionDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
