...
// checks if the CallbackParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallbackParam{}

// CallbackParam Callback URL and optional headers
...
func (o CallbackParam) MarshalJSON() ([]byte, error) {
...
func (o CallbackParam) ToMap() (map[string]interface{}, error) {
...
type NullableCallbackParam struct {
	value *CallbackParam
	isSet bool
}

func (v NullableCallbackParam) Get() *CallbackParam {
	return v.value
}

func (v *NullableCallbackParam) Set(val *CallbackParam) {
	v.value = val
	v.isSet = true
}

func (v NullableCallbackParam) IsSet() bool {
	return v.isSet
}

func (v *NullableCallbackParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallbackParam(val *CallbackParam) *NullableCallbackParam {
	return &NullableCallbackParam{value: val, isSet: true}
}

func (v NullableCallbackParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallbackParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
