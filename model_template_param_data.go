...
// TemplateParamData - struct for TemplateParamData
type TemplateParamData struct {
	ArrayOfMapmapOfStringAny *[]map[string]interface{}
	MapmapOfStringAny *map[string]interface{}
}

// []map[string]interface{}AsTemplateParamData is a convenience function that returns []map[string]interface{} wrapped in TemplateParamData
func ArrayOfMapmapOfStringAnyAsTemplateParamData(v *[]map[string]interface{}) TemplateParamData {
...
// map[string]interface{}AsTemplateParamData is a convenience function that returns map[string]interface{} wrapped in TemplateParamData
func MapmapOfStringAnyAsTemplateParamData(v *map[string]interface{}) TemplateParamData {
	return TemplateParamData{
		MapmapOfStringAny: v,
	}
}
...
func (dst *TemplateParamData) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TemplateParamData)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TemplateParamData)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TemplateParamData) MarshalJSON() ([]byte, error) {
...
func (obj *TemplateParamData) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj TemplateParamData) GetActualInstanceValue() (interface{}) {
	if obj.ArrayOfMapmapOfStringAny != nil {
		return *obj.ArrayOfMapmapOfStringAny
	}
...
type NullableTemplateParamData struct {
	value *TemplateParamData
	isSet bool
}

func (v NullableTemplateParamData) Get() *TemplateParamData {
	return v.value
}

func (v *NullableTemplateParamData) Set(val *TemplateParamData) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateParamData) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateParamData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateParamData(val *TemplateParamData) *NullableTemplateParamData {
	return &NullableTemplateParamData{value: val, isSet: true}
}

func (v NullableTemplateParamData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateParamData) UnmarshalJSON(src []byte) error {
	v.isSet = true
