...
type InlineObject struct {
	...
	Meta *InlineObjectMeta `json:"meta,omitempty"`
}
...
// SetMeta gets a reference to the given InlineObjectMeta and assigns it to the Meta field.
