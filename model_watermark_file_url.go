...
// checks if the WatermarkFileUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatermarkFileUrl{}

// WatermarkFileUrl struct for WatermarkFileUrl
type WatermarkFileUrl struct {
...
type _WatermarkFileUrl WatermarkFileUrl
...
func (o WatermarkFileUrl) MarshalJSON() ([]byte, error) {
...
func (o WatermarkFileUrl) ToMap() (map[string]interface{}, error) {
...
func (o *WatermarkFileUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varWatermarkFileUrl := _WatermarkFileUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWatermarkFileUrl)

	if err != nil {
		return err
	}

	*o = WatermarkFileUrl(varWatermarkFileUrl)

	return err
}

type NullableWatermarkFileUrl struct {
	value *WatermarkFileUrl
	isSet bool
}

func (v NullableWatermarkFileUrl) Get() *WatermarkFileUrl {
	return v.value
}

func (v *NullableWatermarkFileUrl) Set(val *WatermarkFileUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkFileUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkFileUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkFileUrl(val *WatermarkFileUrl) *NullableWatermarkFileUrl {
	return &NullableWatermarkFileUrl{value: val, isSet: true}
}

func (v NullableWatermarkFileUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkFileUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
