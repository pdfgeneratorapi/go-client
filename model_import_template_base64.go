...
// checks if the ImportTemplateBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportTemplateBase64{}

// ImportTemplateBase64 struct for ImportTemplateBase64
type ImportTemplateBase64 struct {
	Template ImportTemplateUrlTemplate `json:"template"`
	// PDF file from base64 string to import
	FileBase64 string `json:"file_base64"`
}

type _ImportTemplateBase64 ImportTemplateBase64
...
func (o *ImportTemplateBase64) GetTemplate() ImportTemplateUrlTemplate {
	if o == nil {
		var ret ImportTemplateUrlTemplate
		return ret
	}
...
func (o ImportTemplateBase64) MarshalJSON() ([]byte, error) {
...
func (o ImportTemplateBase64) ToMap() (map[string]interface{}, error) {
...
func (o *ImportTemplateBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varImportTemplateBase64 := _ImportTemplateBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportTemplateBase64)

	if err != nil {
		return err
	}

	*o = ImportTemplateBase64(varImportTemplateBase64)

	return err
}

type NullableImportTemplateBase64 struct {
	value *ImportTemplateBase64
	isSet bool
}

func (v NullableImportTemplateBase64) Get() *ImportTemplateBase64 {
	return v.value
}

func (v *NullableImportTemplateBase64) Set(val *ImportTemplateBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableImportTemplateBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableImportTemplateBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportTemplateBase64(val *ImportTemplateBase64) *NullableImportTemplateBase64 {
	return &NullableImportTemplateBase64{value: val, isSet: true}
}

func (v NullableImportTemplateBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportTemplateBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
