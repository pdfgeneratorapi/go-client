...
// checks if the DocumentAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentAction{}

// DocumentAction struct for DocumentAction
type DocumentAction struct {
	// The action performed on the document.
	Action *string `json:"action,omitempty"`
	Person *DocumentUser `json:"person,omitempty"`
...
// SetPerson gets a reference to the given DocumentUser and assigns it to the Person field.
...
func (o DocumentAction) MarshalJSON() ([]byte, error) {
...
func (o DocumentAction) ToMap() (map[string]interface{}, error) {
...
type NullableDocumentAction struct {
	value *DocumentAction
	isSet bool
}

func (v NullableDocumentAction) Get() *DocumentAction {
	return v.value
}

func (v *NullableDocumentAction) Set(val *DocumentAction) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentAction) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentAction(val *DocumentAction) *NullableDocumentAction {
	return &NullableDocumentAction{value: val, isSet: true}
}

func (v NullableDocumentAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
