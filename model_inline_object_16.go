...
type InlineObject16 struct {
	Response []DocumentVersion `json:"response,omitempty"`
}
...
func (o *InlineObject16) GetResponse() []DocumentVersion {
...
func (o *InlineObject16) GetResponseOk() ([]DocumentVersion, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
// SetResponse gets a reference to the given []DocumentVersion and assigns it to the Response field.
func (o *InlineObject16) SetResponse(v []DocumentVersion) {
	o.Response = v
}
