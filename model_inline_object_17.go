...
type InlineObject17 struct {
	Response []DocumentAction `json:"response,omitempty"`
}
...
func (o *InlineObject17) GetResponse() []DocumentAction {
	if o == nil || IsNil(o.Response) {
		var ret []DocumentAction
		return ret
	}
	return o.Response
}
...
func (o *InlineObject17) GetResponseOk() ([]DocumentAction, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
// SetResponse gets a reference to the given []DocumentAction and assigns it to the Response field.
func (o *InlineObject17) SetResponse(v []DocumentAction) {
	o.Response = v
}
