...
type InlineObject17 struct {
	Response *DocumentSignatures `json:"response,omitempty"`
}
...
func (o *InlineObject17) GetResponse() DocumentSignatures {
	if o == nil || IsNil(o.Response) {
		var ret DocumentSignatures
		return ret
	}
	return *o.Response
}
...
func (o *InlineObject17) GetResponseOk() (*DocumentSignatures, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject17) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given DocumentSignatures and assigns it to the Response field.
func (o *InlineObject17) SetResponse(v DocumentSignatures) {
	o.Response = &v
}
