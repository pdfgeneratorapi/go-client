...
// checks if the PrefillParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrefillParam{}

// PrefillParam Viewer prefill data, encrypted into the viewer URL. Only applied when `output` is `viewer`.
type PrefillParam struct {
...
// NewPrefillParam instantiates a new PrefillParam object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPrefillParam() *PrefillParam {
	this := PrefillParam{}
...
// NewPrefillParamWithDefaults instantiates a new PrefillParam object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPrefillParamWithDefaults() *PrefillParam {
	this := PrefillParam{}
	var editable bool = true
	this.Editable = &editable
	return &this
...
func (o *PrefillParam) GetIdCode() string {
...
func (o *PrefillParam) GetIdCodeOk() (*string, bool) {
	if o == nil || IsNil(o.IdCode) {
		return nil, false
	}
...
func (o *PrefillParam) HasIdCode() bool {
	if o != nil && !IsNil(o.IdCode) {
		return true
	}
...
func (o *PrefillParam) SetIdCode(v string) {
	o.IdCode = &v
}

// GetFirstName returns the FirstName field value if set, zero value otherwise.
func (o *PrefillParam) GetFirstName() string {
...
// and a boolean to check if the value has been set.
func (o *PrefillParam) GetFirstNameOk() (*string, bool) {
	if o == nil || IsNil(o.FirstName) {
		return nil, false
	}
...
func (o *PrefillParam) HasFirstName() bool {
	if o != nil && !IsNil(o.FirstName) {
		return true
	}
...
func (o *PrefillParam) SetFirstName(v string) {
	o.FirstName = &v
}

// GetLastName returns the LastName field value if set, zero value otherwise.
func (o *PrefillParam) GetLastName() string {
...
// and a boolean to check if the value has been set.
func (o *PrefillParam) GetLastNameOk() (*string, bool) {
	if o == nil || IsNil(o.LastName) {
		return nil, false
	}
...
func (o *PrefillParam) HasLastName() bool {
	if o != nil && !IsNil(o.LastName) {
		return true
	}
...
func (o *PrefillParam) SetLastName(v string) {
	o.LastName = &v
}

// GetEmail returns the Email field value if set, zero value otherwise.
func (o *PrefillParam) GetEmail() string {
...
// and a boolean to check if the value has been set.
func (o *PrefillParam) GetEmailOk() (*string, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *PrefillParam) SetEmail(v string) {
	o.Email = &v
}

// GetEditable returns the Editable field value if set, zero value otherwise.
func (o *PrefillParam) GetEditable() bool {
...
// and a boolean to check if the value has been set.
func (o *PrefillParam) GetEditableOk() (*bool, bool) {
	if o == nil || IsNil(o.Editable) {
		return nil, false
	}
...
func (o *PrefillParam) HasEditable() bool {
	if o != nil && !IsNil(o.Editable) {
		return true
	}
...
func (o *PrefillParam) SetEditable(v bool) {
	o.Editable = &v
}

func (o PrefillParam) MarshalJSON() ([]byte, error) {
...
func (o PrefillParam) ToMap() (map[string]interface{}, error) {
...
type NullablePrefillParam struct {
	value *PrefillParam
	isSet bool
}

func (v NullablePrefillParam) Get() *PrefillParam {
	return v.value
}

func (v *NullablePrefillParam) Set(val *PrefillParam) {
	v.value = val
	v.isSet = true
}

func (v NullablePrefillParam) IsSet() bool {
	return v.isSet
}

func (v *NullablePrefillParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrefillParam(val *PrefillParam) *NullablePrefillParam {
	return &NullablePrefillParam{value: val, isSet: true}
}

func (v NullablePrefillParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrefillParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
