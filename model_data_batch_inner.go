...
// checks if the DataBatchInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataBatchInner{}

// DataBatchInner struct for DataBatchInner
type DataBatchInner struct {
	// Template id
...
func (o DataBatchInner) MarshalJSON() ([]byte, error) {
...
func (o DataBatchInner) ToMap() (map[string]interface{}, error) {
...
type NullableDataBatchInner struct {
	value *DataBatchInner
	isSet bool
}

func (v NullableDataBatchInner) Get() *DataBatchInner {
	return v.value
}

func (v *NullableDataBatchInner) Set(val *DataBatchInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDataBatchInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDataBatchInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataBatchInner(val *DataBatchInner) *NullableDataBatchInner {
	return &NullableDataBatchInner{value: val, isSet: true}
}

func (v NullableDataBatchInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataBatchInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
