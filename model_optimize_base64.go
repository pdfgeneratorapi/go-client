...
// checks if the OptimizeBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptimizeBase64{}

// OptimizeBase64 struct for OptimizeBase64
type OptimizeBase64 struct {
...
type _OptimizeBase64 OptimizeBase64
...
func (o OptimizeBase64) MarshalJSON() ([]byte, error) {
...
func (o OptimizeBase64) ToMap() (map[string]interface{}, error) {
...
func (o *OptimizeBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varOptimizeBase64 := _OptimizeBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOptimizeBase64)

	if err != nil {
		return err
	}

	*o = OptimizeBase64(varOptimizeBase64)

	return err
}

type NullableOptimizeBase64 struct {
	value *OptimizeBase64
	isSet bool
}

func (v NullableOptimizeBase64) Get() *OptimizeBase64 {
	return v.value
}

func (v *NullableOptimizeBase64) Set(val *OptimizeBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableOptimizeBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableOptimizeBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptimizeBase64(val *OptimizeBase64) *NullableOptimizeBase64 {
	return &NullableOptimizeBase64{value: val, isSet: true}
}

func (v NullableOptimizeBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptimizeBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
