...
// checks if the WatermarkText type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatermarkText{}

// WatermarkText struct for WatermarkText
...
type _WatermarkText WatermarkText
...
func (o WatermarkText) MarshalJSON() ([]byte, error) {
...
func (o WatermarkText) ToMap() (map[string]interface{}, error) {
...
func (o *WatermarkText) UnmarshalJSON(data []byte) (err error) {
	...
	varWatermarkText := _WatermarkText{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWatermarkText)

	if err != nil {
		return err
	}

	*o = WatermarkText(varWatermarkText)

	return err
}

type NullableWatermarkText struct {
	value *WatermarkText
	isSet bool
}

func (v NullableWatermarkText) Get() *WatermarkText {
	return v.value
}

func (v *NullableWatermarkText) Set(val *WatermarkText) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkText) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkText(val *WatermarkText) *NullableWatermarkText {
	return &NullableWatermarkText{value: val, isSet: true}
}

func (v NullableWatermarkText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkText) UnmarshalJSON(src []byte) error {
	v.isSet = true
