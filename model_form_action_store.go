...
// checks if the FormActionStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormActionStore{}

// FormActionStore Key-value pair of action configuration.
type FormActionStore struct {
	StoreDocument *bool `json:"store_document,omitempty"`
}

// NewFormActionStore instantiates a new FormActionStore object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFormActionStore() *FormActionStore {
	this := FormActionStore{}
	return &this
}

// NewFormActionStoreWithDefaults instantiates a new FormActionStore object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFormActionStoreWithDefaults() *FormActionStore {
	this := FormActionStore{}
	return &this
}

// GetStoreDocument returns the StoreDocument field value if set, zero value otherwise.
func (o *FormActionStore) GetStoreDocument() bool {
	if o == nil || IsNil(o.StoreDocument) {
		var ret bool
		return ret
	}
	return *o.StoreDocument
}

// GetStoreDocumentOk returns a tuple with the StoreDocument field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FormActionStore) GetStoreDocumentOk() (*bool, bool) {
	if o == nil || IsNil(o.StoreDocument) {
		return nil, false
	}
	return o.StoreDocument, true
}

// HasStoreDocument returns a boolean if a field has been set.
func (o *FormActionStore) HasStoreDocument() bool {
	if o != nil && !IsNil(o.StoreDocument) {
		return true
	}
...
// SetStoreDocument gets a reference to the given bool and assigns it to the StoreDocument field.
func (o *FormActionStore) SetStoreDocument(v bool) {
	o.StoreDocument = &v
}

func (o FormActionStore) MarshalJSON() ([]byte, error) {
...
func (o FormActionStore) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StoreDocument) {
		toSerialize["store_document"] = o.StoreDocument
	}
	return toSerialize, nil
}

type NullableFormActionStore struct {
	value *FormActionStore
	isSet bool
}

func (v NullableFormActionStore) Get() *FormActionStore {
	return v.value
}

func (v *NullableFormActionStore) Set(val *FormActionStore) {
	v.value = val
	v.isSet = true
}

func (v NullableFormActionStore) IsSet() bool {
	return v.isSet
}

func (v *NullableFormActionStore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormActionStore(val *FormActionStore) *NullableFormActionStore {
	return &NullableFormActionStore{value: val, isSet: true}
}

func (v NullableFormActionStore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormActionStore) UnmarshalJSON(src []byte) error {
	v.isSet = true
