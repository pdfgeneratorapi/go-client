...
// checks if the GenerateQRCode201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateQRCode201Response{}

// GenerateQRCode201Response struct for GenerateQRCode201Response
type GenerateQRCode201Response struct {
	// Base64 encoded image if the output=base64. Raw image string if output=file is used
	Response *string `json:"response,omitempty"`
	Meta *GenerateQRCode201ResponseMeta `json:"meta,omitempty"`
}
...
func NewGenerateQRCode201Response() *GenerateQRCode201Response {
	this := GenerateQRCode201Response{}
	return &this
}
...
func (o *GenerateQRCode201Response) GetMeta() GenerateQRCode201ResponseMeta {
	if o == nil || IsNil(o.Meta) {
		var ret GenerateQRCode201ResponseMeta
		return ret
	}
	return *o.Meta
}
...
// SetMeta gets a reference to the given GenerateQRCode201ResponseMeta and assigns it to the Meta field.
func (o *GenerateQRCode201Response) SetMeta(v GenerateQRCode201ResponseMeta) {
	o.Meta = &v
}

func (o GenerateQRCode201Response) MarshalJSON() ([]byte, error) {
...
func (o GenerateQRCode201Response) ToMap() (map[string]interface{}, error) {
...
type NullableGenerateQRCode201Response struct {
	value *GenerateQRCode201Response
	isSet bool
}

func (v NullableGenerateQRCode201Response) Get() *GenerateQRCode201Response {
	return v.value
}

func (v *NullableGenerateQRCode201Response) Set(val *GenerateQRCode201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateQRCode201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateQRCode201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateQRCode201Response(val *GenerateQRCode201Response) *NullableGenerateQRCode201Response {
	return &NullableGenerateQRCode201Response{value: val, isSet: true}
}

func (v NullableGenerateQRCode201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateQRCode201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
