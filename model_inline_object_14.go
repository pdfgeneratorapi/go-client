...
type InlineObject14 struct {
	...
	Response *map[string]InlineObject14ResponseValue `json:"response,omitempty"`
}
...
func (o *InlineObject14) GetResponse() map[string]InlineObject14ResponseValue {
	if o == nil || IsNil(o.Response) {
		var ret map[string]InlineObject14ResponseValue
		return ret
	}
	return *o.Response
}
...
func (o *InlineObject14) GetResponseOk() (*map[string]InlineObject14ResponseValue, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject14) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given map[string]InlineObject14ResponseValue and assigns it to the Response field.
func (o *InlineObject14) SetResponse(v map[string]InlineObject14ResponseValue) {
	o.Response = &v
}
