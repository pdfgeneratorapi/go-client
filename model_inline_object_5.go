...
type InlineObject5 struct {
	Response []Workspace `json:"response,omitempty"`
...
func (o *InlineObject5) GetResponse() []Workspace {
...
func (o *InlineObject5) GetResponseOk() ([]Workspace, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject5) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given []Workspace and assigns it to the Response field.
func (o *InlineObject5) SetResponse(v []Workspace) {
	o.Response = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *InlineObject5) GetMeta() PaginationMeta {
...
// and a boolean to check if the value has been set.
func (o *InlineObject5) GetMetaOk() (*PaginationMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *InlineObject5) SetMeta(v PaginationMeta) {
	o.Meta = &v
}
