...
// checks if the WatermarkImageContentUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatermarkImageContentUrl{}

// WatermarkImageContentUrl struct for WatermarkImageContentUrl
type WatermarkImageContentUrl struct {
	// URL to an image
...
type _WatermarkImageContentUrl WatermarkImageContentUrl
...
func (o WatermarkImageContentUrl) MarshalJSON() ([]byte, error) {
...
func (o WatermarkImageContentUrl) ToMap() (map[string]interface{}, error) {
...
func (o *WatermarkImageContentUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varWatermarkImageContentUrl := _WatermarkImageContentUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWatermarkImageContentUrl)

	if err != nil {
		return err
	}

	*o = WatermarkImageContentUrl(varWatermarkImageContentUrl)

	return err
}

type NullableWatermarkImageContentUrl struct {
	value *WatermarkImageContentUrl
	isSet bool
}

func (v NullableWatermarkImageContentUrl) Get() *WatermarkImageContentUrl {
	return v.value
}

func (v *NullableWatermarkImageContentUrl) Set(val *WatermarkImageContentUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkImageContentUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkImageContentUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkImageContentUrl(val *WatermarkImageContentUrl) *NullableWatermarkImageContentUrl {
	return &NullableWatermarkImageContentUrl{value: val, isSet: true}
}

func (v NullableWatermarkImageContentUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkImageContentUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
