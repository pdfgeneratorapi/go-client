...
func (o *InlineObject4) GetResponse() []Template {
...
func (o *InlineObject4) GetResponseOk() ([]Template, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject4) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given []Template and assigns it to the Response field.
func (o *InlineObject4) SetResponse(v []Template) {
	o.Response = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *InlineObject4) GetMeta() PaginationMeta {
...
// and a boolean to check if the value has been set.
func (o *InlineObject4) GetMetaOk() (*PaginationMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *InlineObject4) SetMeta(v PaginationMeta) {
	o.Meta = &v
}
