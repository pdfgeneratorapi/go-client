...
// InlineObject14ResponseValueValue - Current field value
type InlineObject14ResponseValueValue struct {
	ArrayOfString *[]string
	Bool *bool
	String *string
}

// []stringAsInlineObject14ResponseValueValue is a convenience function that returns []string wrapped in InlineObject14ResponseValueValue
func ArrayOfStringAsInlineObject14ResponseValueValue(v *[]string) InlineObject14ResponseValueValue {
	return InlineObject14ResponseValueValue{
		ArrayOfString: v,
	}
}

// boolAsInlineObject14ResponseValueValue is a convenience function that returns bool wrapped in InlineObject14ResponseValueValue
func BoolAsInlineObject14ResponseValueValue(v *bool) InlineObject14ResponseValueValue {
	return InlineObject14ResponseValueValue{
		Bool: v,
	}
}
...
// stringAsInlineObject14ResponseValueValue is a convenience function that returns string wrapped in InlineObject14ResponseValueValue
func StringAsInlineObject14ResponseValueValue(v *string) InlineObject14ResponseValueValue {
	return InlineObject14ResponseValueValue{
		String: v,
	}
}
...
func (dst *InlineObject14ResponseValueValue) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(InlineObject14ResponseValueValue)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(InlineObject14ResponseValueValue)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src InlineObject14ResponseValueValue) MarshalJSON() ([]byte, error) {
...
func (obj *InlineObject14ResponseValueValue) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj InlineObject14ResponseValueValue) GetActualInstanceValue() (interface{}) {
	if obj.ArrayOfString != nil {
		return *obj.ArrayOfString
	}
...
type NullableInlineObject14ResponseValueValue struct {
	value *InlineObject14ResponseValueValue
	isSet bool
}

func (v NullableInlineObject14ResponseValueValue) Get() *InlineObject14ResponseValueValue {
	return v.value
}

func (v *NullableInlineObject14ResponseValueValue) Set(val *InlineObject14ResponseValueValue) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject14ResponseValueValue) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject14ResponseValueValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject14ResponseValueValue(val *InlineObject14ResponseValueValue) *NullableInlineObject14ResponseValueValue {
	return &NullableInlineObject14ResponseValueValue{value: val, isSet: true}
}

func (v NullableInlineObject14ResponseValueValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject14ResponseValueValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
