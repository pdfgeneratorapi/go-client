...
// checks if the InlineObject1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject1Response{}

// InlineObject1Response struct for InlineObject1Response
type InlineObject1Response struct {
	// True if template configuration was valid
	Valid *bool `json:"valid,omitempty"`
}

// NewInlineObject1Response instantiates a new InlineObject1Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineObject1Response() *InlineObject1Response {
	this := InlineObject1Response{}
	var valid bool = true
	this.Valid = &valid
	return &this
}

// NewInlineObject1ResponseWithDefaults instantiates a new InlineObject1Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineObject1ResponseWithDefaults() *InlineObject1Response {
	this := InlineObject1Response{}
	var valid bool = true
	this.Valid = &valid
	return &this
...
func (o *InlineObject1Response) GetValid() bool {
...
func (o *InlineObject1Response) GetValidOk() (*bool, bool) {
	if o == nil || IsNil(o.Valid) {
		return nil, false
	}
	return o.Valid, true
...
func (o *InlineObject1Response) HasValid() bool {
	if o != nil && !IsNil(o.Valid) {
		return true
	}
...
func (o *InlineObject1Response) SetValid(v bool) {
	o.Valid = &v
}

func (o InlineObject1Response) MarshalJSON() ([]byte, error) {
...
func (o InlineObject1Response) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject1Response struct {
	value *InlineObject1Response
	isSet bool
}

func (v NullableInlineObject1Response) Get() *InlineObject1Response {
	return v.value
}

func (v *NullableInlineObject1Response) Set(val *InlineObject1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject1Response(val *InlineObject1Response) *NullableInlineObject1Response {
	return &NullableInlineObject1Response{value: val, isSet: true}
}

func (v NullableInlineObject1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
