...
// checks if the MakeAccessibleUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MakeAccessibleUrl{}

// MakeAccessibleUrl struct for MakeAccessibleUrl
type MakeAccessibleUrl struct {
...
type _MakeAccessibleUrl MakeAccessibleUrl
...
func (o MakeAccessibleUrl) MarshalJSON() ([]byte, error) {
...
func (o MakeAccessibleUrl) ToMap() (map[string]interface{}, error) {
...
func (o *MakeAccessibleUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varMakeAccessibleUrl := _MakeAccessibleUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMakeAccessibleUrl)

	if err != nil {
		return err
	}

	*o = MakeAccessibleUrl(varMakeAccessibleUrl)

	return err
}

type NullableMakeAccessibleUrl struct {
	value *MakeAccessibleUrl
	isSet bool
}

func (v NullableMakeAccessibleUrl) Get() *MakeAccessibleUrl {
	return v.value
}

func (v *NullableMakeAccessibleUrl) Set(val *MakeAccessibleUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableMakeAccessibleUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableMakeAccessibleUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMakeAccessibleUrl(val *MakeAccessibleUrl) *NullableMakeAccessibleUrl {
	return &NullableMakeAccessibleUrl{value: val, isSet: true}
}

func (v NullableMakeAccessibleUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMakeAccessibleUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
