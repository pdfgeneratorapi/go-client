...
// GetDataIndex returns the DataIndex field value if set, zero value otherwise.
func (o *Component) GetDataIndex() string {
	if o == nil || IsNil(o.DataIndex) {
		var ret string
		return ret
	}
	return *o.DataIndex
...
// GetDataIndexOk returns a tuple with the DataIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Component) GetDataIndexOk() (*string, bool) {
	if o == nil || IsNil(o.DataIndex) {
		return nil, false
	}
	return o.DataIndex, true
}
...
// SetDataIndex gets a reference to the given string and assigns it to the DataIndex field.
...
func (o Component) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DataIndex) {
		toSerialize["dataIndex"] = o.DataIndex
	}
