...
// checks if the WatermarkBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatermarkBase64{}

// WatermarkBase64 struct for WatermarkBase64
type WatermarkBase64 struct {
	// PDF file from base64 string to add the watermark to
	FileBase64 string `json:"file_base64"`
	Watermark WatermarkFileUrlWatermark `json:"watermark"`
...
type _WatermarkBase64 WatermarkBase64
...
func (o *WatermarkBase64) GetWatermark() WatermarkFileUrlWatermark {
	if o == nil {
		var ret WatermarkFileUrlWatermark
		return ret
	}
...
func (o WatermarkBase64) MarshalJSON() ([]byte, error) {
...
func (o WatermarkBase64) ToMap() (map[string]interface{}, error) {
...
func (o *WatermarkBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varWatermarkBase64 := _WatermarkBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWatermarkBase64)

	if err != nil {
		return err
	}

	*o = WatermarkBase64(varWatermarkBase64)

	return err
}

type NullableWatermarkBase64 struct {
	value *WatermarkBase64
	isSet bool
}

func (v NullableWatermarkBase64) Get() *WatermarkBase64 {
	return v.value
}

func (v *NullableWatermarkBase64) Set(val *WatermarkBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableWatermarkBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableWatermarkBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatermarkBase64(val *WatermarkBase64) *NullableWatermarkBase64 {
	return &NullableWatermarkBase64{value: val, isSet: true}
}

func (v NullableWatermarkBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatermarkBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
