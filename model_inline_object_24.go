...
func (o *InlineObject24) GetMessage() string {
...
func (o *InlineObject24) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject24) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject24) SetMessage(v string) {
	o.Message = &v
}
