...
// checks if the InlineObject23Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject23Response{}

// InlineObject23Response struct for InlineObject23Response
type InlineObject23Response struct {
...
func (o InlineObject23Response) MarshalJSON() ([]byte, error) {
...
func (o InlineObject23Response) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject23Response struct {
	value *InlineObject23Response
	isSet bool
}

func (v NullableInlineObject23Response) Get() *InlineObject23Response {
	return v.value
}

func (v *NullableInlineObject23Response) Set(val *InlineObject23Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject23Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject23Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject23Response(val *InlineObject23Response) *NullableInlineObject23Response {
	return &NullableInlineObject23Response{value: val, isSet: true}
}

func (v NullableInlineObject23Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject23Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
