...
type InlineObject15 struct {
	Response []Document `json:"response,omitempty"`
...
func (o *InlineObject15) GetResponse() []Document {
...
func (o *InlineObject15) GetResponseOk() ([]Document, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject15) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given []Document and assigns it to the Response field.
func (o *InlineObject15) SetResponse(v []Document) {
	o.Response = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *InlineObject15) GetMeta() PaginationMeta {
...
// and a boolean to check if the value has been set.
func (o *InlineObject15) GetMetaOk() (*PaginationMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *InlineObject15) SetMeta(v PaginationMeta) {
	o.Meta = &v
}
