...
// checks if the OpenEditorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenEditorRequest{}

// OpenEditorRequest struct for OpenEditorRequest
type OpenEditorRequest struct {
	Data *OpenEditorRequestData `json:"data,omitempty"`
...
// SetData gets a reference to the given OpenEditorRequestData and assigns it to the Data field.
...
func (o OpenEditorRequest) MarshalJSON() ([]byte, error) {
...
func (o OpenEditorRequest) ToMap() (map[string]interface{}, error) {
...
type NullableOpenEditorRequest struct {
	value *OpenEditorRequest
	isSet bool
}

func (v NullableOpenEditorRequest) Get() *OpenEditorRequest {
	return v.value
}

func (v *NullableOpenEditorRequest) Set(val *OpenEditorRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenEditorRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenEditorRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenEditorRequest(val *OpenEditorRequest) *NullableOpenEditorRequest {
	return &NullableOpenEditorRequest{value: val, isSet: true}
}

func (v NullableOpenEditorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenEditorRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
