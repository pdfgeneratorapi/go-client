...
// checks if the PublicTemplateLibraryItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicTemplateLibraryItem{}

// PublicTemplateLibraryItem struct for PublicTemplateLibraryItem
type PublicTemplateLibraryItem struct {
	...
	PreviewImageUrl NullableString `json:"preview_image_url,omitempty"`
	// URL to the template sample data
	SampleDataUrl NullableString `json:"sample_data_url,omitempty"`
}
...
func NewPublicTemplateLibraryItem() *PublicTemplateLibraryItem {
	this := PublicTemplateLibraryItem{}
	return &this
}
...
func (o *PublicTemplateLibraryItem) GetPreviewImageUrl() string {
	if o == nil || IsNil(o.PreviewImageUrl.Get()) {
		var ret string
		return ret
	}
...
func (o *PublicTemplateLibraryItem) SetPreviewImageUrlNil() {
...
// GetSampleDataUrl returns the SampleDataUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PublicTemplateLibraryItem) GetSampleDataUrl() string {
	if o == nil || IsNil(o.SampleDataUrl.Get()) {
		var ret string
		return ret
	}
	return *o.SampleDataUrl.Get()
}

// GetSampleDataUrlOk returns a tuple with the SampleDataUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetSampleDataUrl gets a reference to the given NullableString and assigns it to the SampleDataUrl field.
func (o *PublicTemplateLibraryItem) SetSampleDataUrl(v string) {
	o.SampleDataUrl.Set(&v)
}
// SetSampleDataUrlNil sets the value for SampleDataUrl to be an explicit nil
func (o *PublicTemplateLibraryItem) SetSampleDataUrlNil() {
	o.SampleDataUrl.Set(nil)
}
...
func (o *PublicTemplateLibraryItem) UnsetSampleDataUrl() {
	o.SampleDataUrl.Unset()
}

func (o PublicTemplateLibraryItem) MarshalJSON() ([]byte, error) {
...
func (o PublicTemplateLibraryItem) ToMap() (map[string]interface{}, error) {
	...
	if o.PreviewImageUrl.IsSet() {
		toSerialize["preview_image_url"] = o.PreviewImageUrl.Get()
	}
	if o.SampleDataUrl.IsSet() {
		toSerialize["sample_data_url"] = o.SampleDataUrl.Get()
	}
	return toSerialize, nil
}

type NullablePublicTemplateLibraryItem struct {
	value *PublicTemplateLibraryItem
	isSet bool
}

func (v NullablePublicTemplateLibraryItem) Get() *PublicTemplateLibraryItem {
	return v.value
}

func (v *NullablePublicTemplateLibraryItem) Set(val *PublicTemplateLibraryItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicTemplateLibraryItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicTemplateLibraryItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicTemplateLibraryItem(val *PublicTemplateLibraryItem) *NullablePublicTemplateLibraryItem {
	return &NullablePublicTemplateLibraryItem{value: val, isSet: true}
}

func (v NullablePublicTemplateLibraryItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicTemplateLibraryItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
