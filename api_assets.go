...
func (r ApiGenerateQRCodeRequest) GenerateQRCodeRequest(generateQRCodeRequest GenerateQRCodeRequest) ApiGenerateQRCodeRequest {
	r.generateQRCodeRequest = &generateQRCodeRequest
	return r
}

func (r ApiGenerateQRCodeRequest) Execute() (*GenerateQRCode201Response, *http.Response, error) {
...
*/
func (a *AssetsAPIService) GenerateQRCode(ctx context.Context) ApiGenerateQRCodeRequest {
	return ApiGenerateQRCodeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AssetsAPIService) GenerateQRCodeExecute(r ApiGenerateQRCodeRequest) (*GenerateQRCode201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenerateQRCode201Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetsAPIService.GenerateQRCode")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/assets/qrcode"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.generateQRCodeRequest == nil {
		return localVarReturnValue, nil, reportError("generateQRCodeRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.generateQRCodeRequest
