...
type InlineObject20 struct {
	...
	Meta *InlineObject20Meta `json:"meta,omitempty"`
}
...
// SetMeta gets a reference to the given InlineObject20Meta and assigns it to the Meta field.
