...
// GetIsMasterWorkspace returns the IsMasterWorkspace field value if set, zero value otherwise.
func (o *Workspace) GetIsMasterWorkspace() bool {
	if o == nil || IsNil(o.IsMasterWorkspace) {
		var ret bool
		return ret
	}
	return *o.IsMasterWorkspace
}

// GetIsMasterWorkspaceOk returns a tuple with the IsMasterWorkspace field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Workspace) GetIsMasterWorkspaceOk() (*bool, bool) {
	if o == nil || IsNil(o.IsMasterWorkspace) {
		return nil, false
	}
	return o.IsMasterWorkspace, true
}
...
// SetIsMasterWorkspace gets a reference to the given bool and assigns it to the IsMasterWorkspace field.
func (o *Workspace) SetIsMasterWorkspace(v bool) {
	o.IsMasterWorkspace = &v
}
...
func (o Workspace) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsMasterWorkspace) {
		toSerialize["is_master_workspace"] = o.IsMasterWorkspace
	}
