...
// OpenEditorRequestData - Data used to generate the document. This can be an object or array of objects.
type OpenEditorRequestData struct {
	ArrayOfMapmapOfStringAny *[]map[string]interface{}
	MapmapOfStringAny *map[string]interface{}
}

// []map[string]interface{}AsOpenEditorRequestData is a convenience function that returns []map[string]interface{} wrapped in OpenEditorRequestData
func ArrayOfMapmapOfStringAnyAsOpenEditorRequestData(v *[]map[string]interface{}) OpenEditorRequestData {
...
// map[string]interface{}AsOpenEditorRequestData is a convenience function that returns map[string]interface{} wrapped in OpenEditorRequestData
func MapmapOfStringAnyAsOpenEditorRequestData(v *map[string]interface{}) OpenEditorRequestData {
	return OpenEditorRequestData{
		MapmapOfStringAny: v,
	}
}
...
func (dst *OpenEditorRequestData) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(OpenEditorRequestData)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(OpenEditorRequestData)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src OpenEditorRequestData) MarshalJSON() ([]byte, error) {
...
func (obj *OpenEditorRequestData) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj OpenEditorRequestData) GetActualInstanceValue() (interface{}) {
	if obj.ArrayOfMapmapOfStringAny != nil {
		return *obj.ArrayOfMapmapOfStringAny
	}
...
type NullableOpenEditorRequestData struct {
	value *OpenEditorRequestData
	isSet bool
}

func (v NullableOpenEditorRequestData) Get() *OpenEditorRequestData {
	return v.value
}

func (v *NullableOpenEditorRequestData) Set(val *OpenEditorRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenEditorRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenEditorRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenEditorRequestData(val *OpenEditorRequestData) *NullableOpenEditorRequestData {
	return &NullableOpenEditorRequestData{value: val, isSet: true}
}

func (v NullableOpenEditorRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenEditorRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
