...
// checks if the DocumentSignatures type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentSignatures{}

// DocumentSignatures struct for DocumentSignatures
type DocumentSignatures struct {
	...
	HasLongTermValidation *bool `json:"has_long_term_validation,omitempty"`
	// The last signature covers every byte, so nothing was appended after it.
	CoversWholeDocument *bool `json:"covers_whole_document,omitempty"`
	// Timestamp-only signatures, counted rather than listed: they are machinery, not people, and would double every signer. 
	DocumentTimestamps *int32 `json:"document_timestamps,omitempty"`
...
// GetHasLongTermValidation returns the HasLongTermValidation field value if set, zero value otherwise.
func (o *DocumentSignatures) GetHasLongTermValidation() bool {
	if o == nil || IsNil(o.HasLongTermValidation) {
		var ret bool
		return ret
	}
	return *o.HasLongTermValidation
}

// GetHasLongTermValidationOk returns a tuple with the HasLongTermValidation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DocumentSignatures) GetHasLongTermValidationOk() (*bool, bool) {
	if o == nil || IsNil(o.HasLongTermValidation) {
		return nil, false
	}
	return o.HasLongTermValidation, true
}
...
// SetHasLongTermValidation gets a reference to the given bool and assigns it to the HasLongTermValidation field.
func (o *DocumentSignatures) SetHasLongTermValidation(v bool) {
	o.HasLongTermValidation = &v
}

// GetCoversWholeDocument returns the CoversWholeDocument field value if set, zero value otherwise.
func (o *DocumentSignatures) GetCoversWholeDocument() bool {
	if o == nil || IsNil(o.CoversWholeDocument) {
		var ret bool
		return ret
	}
	return *o.CoversWholeDocument
}

// GetCoversWholeDocumentOk returns a tuple with the CoversWholeDocument field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DocumentSignatures) GetCoversWholeDocumentOk() (*bool, bool) {
	if o == nil || IsNil(o.CoversWholeDocument) {
		return nil, false
	}
	return o.CoversWholeDocument, true
}
...
// SetCoversWholeDocument gets a reference to the given bool and assigns it to the CoversWholeDocument field.
func (o *DocumentSignatures) SetCoversWholeDocument(v bool) {
	o.CoversWholeDocument = &v
}

// GetDocumentTimestamps returns the DocumentTimestamps field value if set, zero value otherwise.
func (o *DocumentSignatures) GetDocumentTimestamps() int32 {
	if o == nil || IsNil(o.DocumentTimestamps) {
		var ret int32
		return ret
	}
	return *o.DocumentTimestamps
}

// GetDocumentTimestampsOk returns a tuple with the DocumentTimestamps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DocumentSignatures) GetDocumentTimestampsOk() (*int32, bool) {
	if o == nil || IsNil(o.DocumentTimestamps) {
		return nil, false
	}
	return o.DocumentTimestamps, true
}
...
// SetDocumentTimestamps gets a reference to the given int32 and assigns it to the DocumentTimestamps field.
func (o *DocumentSignatures) SetDocumentTimestamps(v int32) {
	o.DocumentTimestamps = &v
}
...
// SetSignatures gets a reference to the given []DocumentSignature and assigns it to the Signatures field.
func (o *DocumentSignatures) SetSignatures(v []DocumentSignature) {
	o.Signatures = v
}

func (o DocumentSignatures) MarshalJSON() ([]byte, error) {
...
func (o DocumentSignatures) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasLongTermValidation) {
		toSerialize["has_long_term_validation"] = o.HasLongTermValidation
	}
	if !IsNil(o.CoversWholeDocument) {
		toSerialize["covers_whole_document"] = o.CoversWholeDocument
	}
	if !IsNil(o.DocumentTimestamps) {
		toSerialize["document_timestamps"] = o.DocumentTimestamps
	}
...
type NullableDocumentSignatures struct {
	value *DocumentSignatures
	isSet bool
}

func (v NullableDocumentSignatures) Get() *DocumentSignatures {
	return v.value
}

func (v *NullableDocumentSignatures) Set(val *DocumentSignatures) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentSignatures) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentSignatures) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentSignatures(val *DocumentSignatures) *NullableDocumentSignatures {
	return &NullableDocumentSignatures{value: val, isSet: true}
}

func (v NullableDocumentSignatures) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentSignatures) UnmarshalJSON(src []byte) error {
	v.isSet = true
