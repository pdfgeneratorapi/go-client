...
// checks if the ConvertPDF2ImageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertPDF2ImageRequest{}

// ConvertPDF2ImageRequest struct for ConvertPDF2ImageRequest
type ConvertPDF2ImageRequest struct {
...
func NewConvertPDF2ImageRequest() *ConvertPDF2ImageRequest {
	this := ConvertPDF2ImageRequest{}
	var format string = "png"
	this.Format = &format
	var quality int32 = 85
	this.Quality = &quality
	var resolution int32 = 150
...
func (o ConvertPDF2ImageRequest) MarshalJSON() ([]byte, error) {
...
func (o ConvertPDF2ImageRequest) ToMap() (map[string]interface{}, error) {
...
type NullableConvertPDF2ImageRequest struct {
	value *ConvertPDF2ImageRequest
	isSet bool
}

func (v NullableConvertPDF2ImageRequest) Get() *ConvertPDF2ImageRequest {
	return v.value
}

func (v *NullableConvertPDF2ImageRequest) Set(val *ConvertPDF2ImageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertPDF2ImageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertPDF2ImageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertPDF2ImageRequest(val *ConvertPDF2ImageRequest) *NullableConvertPDF2ImageRequest {
	return &NullableConvertPDF2ImageRequest{value: val, isSet: true}
}

func (v NullableConvertPDF2ImageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertPDF2ImageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
