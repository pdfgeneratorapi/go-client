...
func (o *InlineObject3) GetResponse() string {
...
func (o *InlineObject3) GetResponseOk() (*string, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject3) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
func (o *InlineObject3) SetResponse(v string) {
	o.Response = &v
}
