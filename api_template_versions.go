...
type ApiDeleteTemplateVersionRequest struct {
	ctx context.Context
...
func (r ApiDeleteTemplateVersionRequest) Execute() (*http.Response, error) {
...
Production versions cannot be deleted.
 ...
 @param templateVersion Unique ID of the template version.
 @return ApiDeleteTemplateVersionRequest
*/
func (a *TemplateVersionsAPIService) DeleteTemplateVersion(ctx context.Context, templateId int32, templateVersion int32) ApiDeleteTemplateVersionRequest {
	return ApiDeleteTemplateVersionRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *TemplateVersionsAPIService) DeleteTemplateVersionExecute(r ApiDeleteTemplateVersionRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TemplateVersionsAPIService.DeleteTemplateVersion")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/templates/{templateId}/versions/{templateVersion}"
...
func (r ApiGetTemplateVersionRequest) Execute() (*InlineObject16, *http.Response, error) {
...
*/
func (a *TemplateVersionsAPIService) GetTemplateVersion(ctx context.Context, templateId int32, templateVersion int32) ApiGetTemplateVersionRequest {
	return ApiGetTemplateVersionRequest{
		ApiService: a,
		ctx: ctx,
		templateId: templateId,
...
func (a *TemplateVersionsAPIService) GetTemplateVersionExecute(r ApiGetTemplateVersionRequest) (*InlineObject16, *http.Response, error) {
	var (
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 422 {
			var v GetTemplateVersion422Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiListTemplateVersionsRequest) PerPage(perPage int32) ApiListTemplateVersionsRequest {
	r.perPage = &perPage
	return r
}

// Page number to return.
func (r ApiListTemplateVersionsRequest) Page(page int32) ApiListTemplateVersionsRequest {
	r.page = &page
	return r
}

func (r ApiListTemplateVersionsRequest) Execute() (*TemplateVersionCollection, *http.Response, error) {
...
*/
func (a *TemplateVersionsAPIService) ListTemplateVersions(ctx context.Context, templateId int32) ApiListTemplateVersionsRequest {
	return ApiListTemplateVersionsRequest{
		ApiService: a,
		ctx: ctx,
		templateId: templateId,
...
func (a *TemplateVersionsAPIService) ListTemplateVersionsExecute(r ApiListTemplateVersionsRequest) (*TemplateVersionCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TemplateVersionCollection
	)
	...
	localVarPath := localBasePath + "/templates/{templateId}/versions"
	localVarPath = strings.Replace(localVarPath, "{"+"templateId"+"}", url.PathEscape(parameterValueToString(r.templateId, "templateId")), -1)
...
func (r ApiPromoteTemplateVersionRequest) Execute() (*PromoteTemplateVersion200Response, *http.Response, error) {
	return r.ApiService.PromoteTemplateVersionExecute(r)
}

/*
PromoteTemplateVersion Promote template version
...
*/
func (a *TemplateVersionsAPIService) PromoteTemplateVersion(ctx context.Context, templateId int32, templateVersion int32) ApiPromoteTemplateVersionRequest {
	return ApiPromoteTemplateVersionRequest{
		ApiService: a,
		ctx: ctx,
		templateId: templateId,
...
func (a *TemplateVersionsAPIService) PromoteTemplateVersionExecute(r ApiPromoteTemplateVersionRequest) (*PromoteTemplateVersion200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PromoteTemplateVersion200Response
	)
	...
	localVarPath := localBasePath + "/templates/{templateId}/versions/{templateVersion}/promote"
	localVarPath = strings.Replace(localVarPath, "{"+"templateId"+"}", url.PathEscape(parameterValueToString(r.templateId, "templateId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"templateVersion"+"}", url.PathEscape(parameterValueToString(r.templateVersion, "templateVersion")), -1)
