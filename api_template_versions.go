...
func (r ApiGetTemplateVersionRequest) Execute() (*InlineObject19, *http.Response, error) {
...
func (a *TemplateVersionsAPIService) GetTemplateVersionExecute(r ApiGetTemplateVersionRequest) (*InlineObject19, *http.Response, error) {
	var (
