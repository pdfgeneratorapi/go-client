...
func (r ApiGetTemplateVersionRequest) Execute() (*InlineObject18, *http.Response, error) {
...
func (a *TemplateVersionsAPIService) GetTemplateVersionExecute(r ApiGetTemplateVersionRequest) (*InlineObject18, *http.Response, error) {
	var (
