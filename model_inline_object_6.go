...
type InlineObject6 struct {
	Response []FormConfiguration `json:"response,omitempty"`
...
func (o *InlineObject6) GetResponse() []FormConfiguration {
...
func (o *InlineObject6) GetResponseOk() ([]FormConfiguration, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject6) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given []FormConfiguration and assigns it to the Response field.
func (o *InlineObject6) SetResponse(v []FormConfiguration) {
	o.Response = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *InlineObject6) GetMeta() PaginationMeta {
...
// and a boolean to check if the value has been set.
func (o *InlineObject6) GetMetaOk() (*PaginationMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *InlineObject6) SetMeta(v PaginationMeta) {
	o.Meta = &v
}
