...
// checks if the CreateEInvoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateEInvoiceRequest{}

// CreateEInvoiceRequest struct for CreateEInvoiceRequest
type CreateEInvoiceRequest struct {
...
type _CreateEInvoiceRequest CreateEInvoiceRequest
...
func NewCreateEInvoiceRequest(data map[string]interface{}) *CreateEInvoiceRequest {
	this := CreateEInvoiceRequest{}
	this.Data = data
	var type_ string = "UBL"
	this.Type = &type_
...
func (o CreateEInvoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateEInvoiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateEInvoiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateEInvoiceRequest := _CreateEInvoiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateEInvoiceRequest)

	if err != nil {
		return err
	}

	*o = CreateEInvoiceRequest(varCreateEInvoiceRequest)

	return err
}

type NullableCreateEInvoiceRequest struct {
	value *CreateEInvoiceRequest
	isSet bool
}

func (v NullableCreateEInvoiceRequest) Get() *CreateEInvoiceRequest {
	return v.value
}

func (v *NullableCreateEInvoiceRequest) Set(val *CreateEInvoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEInvoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEInvoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEInvoiceRequest(val *CreateEInvoiceRequest) *NullableCreateEInvoiceRequest {
	return &NullableCreateEInvoiceRequest{value: val, isSet: true}
}

func (v NullableCreateEInvoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEInvoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
