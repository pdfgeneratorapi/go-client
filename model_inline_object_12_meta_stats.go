...
// checks if the InlineObject12MetaStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject12MetaStats{}

// InlineObject12MetaStats struct for InlineObject12MetaStats
type InlineObject12MetaStats struct {
	// Document original size
	OriginalSize *float32 `json:"original_size,omitempty"`
	// Document size after optimization
	OptimizedSize *float32 `json:"optimized_size,omitempty"`
}

// NewInlineObject12MetaStats instantiates a new InlineObject12MetaStats object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineObject12MetaStats() *InlineObject12MetaStats {
	this := InlineObject12MetaStats{}
	return &this
}

// NewInlineObject12MetaStatsWithDefaults instantiates a new InlineObject12MetaStats object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineObject12MetaStatsWithDefaults() *InlineObject12MetaStats {
	this := InlineObject12MetaStats{}
	return &this
}

// GetOriginalSize returns the OriginalSize field value if set, zero value otherwise.
func (o *InlineObject12MetaStats) GetOriginalSize() float32 {
...
func (o *InlineObject12MetaStats) GetOriginalSizeOk() (*float32, bool) {
	if o == nil || IsNil(o.OriginalSize) {
		return nil, false
	}
...
func (o *InlineObject12MetaStats) HasOriginalSize() bool {
	if o != nil && !IsNil(o.OriginalSize) {
		return true
	}
...
// SetOriginalSize gets a reference to the given float32 and assigns it to the OriginalSize field.
func (o *InlineObject12MetaStats) SetOriginalSize(v float32) {
	o.OriginalSize = &v
}

// GetOptimizedSize returns the OptimizedSize field value if set, zero value otherwise.
func (o *InlineObject12MetaStats) GetOptimizedSize() float32 {
	if o == nil || IsNil(o.OptimizedSize) {
		var ret float32
		return ret
	}
	return *o.OptimizedSize
}

// GetOptimizedSizeOk returns a tuple with the OptimizedSize field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineObject12MetaStats) GetOptimizedSizeOk() (*float32, bool) {
	if o == nil || IsNil(o.OptimizedSize) {
		return nil, false
	}
	return o.OptimizedSize, true
}

// HasOptimizedSize returns a boolean if a field has been set.
func (o *InlineObject12MetaStats) HasOptimizedSize() bool {
	if o != nil && !IsNil(o.OptimizedSize) {
		return true
	}
...
// SetOptimizedSize gets a reference to the given float32 and assigns it to the OptimizedSize field.
func (o *InlineObject12MetaStats) SetOptimizedSize(v float32) {
	o.OptimizedSize = &v
}

func (o InlineObject12MetaStats) MarshalJSON() ([]byte, error) {
...
func (o InlineObject12MetaStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OriginalSize) {
		toSerialize["original_size"] = o.OriginalSize
	}
	if !IsNil(o.OptimizedSize) {
		toSerialize["optimized_size"] = o.OptimizedSize
	}
	return toSerialize, nil
}

type NullableInlineObject12MetaStats struct {
	value *InlineObject12MetaStats
	isSet bool
}

func (v NullableInlineObject12MetaStats) Get() *InlineObject12MetaStats {
	return v.value
}

func (v *NullableInlineObject12MetaStats) Set(val *InlineObject12MetaStats) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject12MetaStats) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject12MetaStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject12MetaStats(val *InlineObject12MetaStats) *NullableInlineObject12MetaStats {
	return &NullableInlineObject12MetaStats{value: val, isSet: true}
}

func (v NullableInlineObject12MetaStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject12MetaStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
