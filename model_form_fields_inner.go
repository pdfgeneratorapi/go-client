...
// checks if the FormFieldsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormFieldsInner{}

// FormFieldsInner Form field definition
type FormFieldsInner struct {
...
func (o FormFieldsInner) MarshalJSON() ([]byte, error) {
...
func (o FormFieldsInner) ToMap() (map[string]interface{}, error) {
...
type NullableFormFieldsInner struct {
	value *FormFieldsInner
	isSet bool
}

func (v NullableFormFieldsInner) Get() *FormFieldsInner {
	return v.value
}

func (v *NullableFormFieldsInner) Set(val *FormFieldsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFormFieldsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFormFieldsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormFieldsInner(val *FormFieldsInner) *NullableFormFieldsInner {
	return &NullableFormFieldsInner{value: val, isSet: true}
}

func (v NullableFormFieldsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormFieldsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
