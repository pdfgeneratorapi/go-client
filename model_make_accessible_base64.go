...
// checks if the MakeAccessibleBase64 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MakeAccessibleBase64{}

// MakeAccessibleBase64 struct for MakeAccessibleBase64
type MakeAccessibleBase64 struct {
	// PDF document in base64 encoded string format
	FileBase64 string `json:"file_base64"`
	// Accessibility processing options
	Options []AccessibilityOption `json:"options,omitempty"`
...
type _MakeAccessibleBase64 MakeAccessibleBase64
...
func NewMakeAccessibleBase64(fileBase64 string) *MakeAccessibleBase64 {
	this := MakeAccessibleBase64{}
	this.FileBase64 = fileBase64
	var output string = "base64"
	this.Output = &output
	return &this
}
...
// GetFileBase64 returns the FileBase64 field value
...
// GetFileBase64Ok returns a tuple with the FileBase64 field value
...
// SetFileBase64 sets field value
...
// SetOptions gets a reference to the given []AccessibilityOption and assigns it to the Options field.
...
func (o MakeAccessibleBase64) MarshalJSON() ([]byte, error) {
...
func (o MakeAccessibleBase64) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["file_base64"] = o.FileBase64
	if !IsNil(o.Options) {
...
func (o *MakeAccessibleBase64) UnmarshalJSON(data []byte) (err error) {
	...
	varMakeAccessibleBase64 := _MakeAccessibleBase64{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMakeAccessibleBase64)

	if err != nil {
		return err
	}

	*o = MakeAccessibleBase64(varMakeAccessibleBase64)

	return err
}

type NullableMakeAccessibleBase64 struct {
	value *MakeAccessibleBase64
	isSet bool
}

func (v NullableMakeAccessibleBase64) Get() *MakeAccessibleBase64 {
	return v.value
}

func (v *NullableMakeAccessibleBase64) Set(val *MakeAccessibleBase64) {
	v.value = val
	v.isSet = true
}

func (v NullableMakeAccessibleBase64) IsSet() bool {
	return v.isSet
}

func (v *NullableMakeAccessibleBase64) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMakeAccessibleBase64(val *MakeAccessibleBase64) *NullableMakeAccessibleBase64 {
	return &NullableMakeAccessibleBase64{value: val, isSet: true}
}

func (v NullableMakeAccessibleBase64) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMakeAccessibleBase64) UnmarshalJSON(src []byte) error {
	v.isSet = true
