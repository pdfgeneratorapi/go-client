...
// checks if the GetTemplateLibrary200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTemplateLibrary200Response{}

// GetTemplateLibrary200Response struct for GetTemplateLibrary200Response
type GetTemplateLibrary200Response struct {
	Response []PublicTemplateLibraryItem `json:"response,omitempty"`
}

// NewGetTemplateLibrary200Response instantiates a new GetTemplateLibrary200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetTemplateLibrary200Response() *GetTemplateLibrary200Response {
	this := GetTemplateLibrary200Response{}
	return &this
}

// NewGetTemplateLibrary200ResponseWithDefaults instantiates a new GetTemplateLibrary200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetTemplateLibrary200ResponseWithDefaults() *GetTemplateLibrary200Response {
	this := GetTemplateLibrary200Response{}
	return &this
}

// GetResponse returns the Response field value if set, zero value otherwise.
func (o *GetTemplateLibrary200Response) GetResponse() []PublicTemplateLibraryItem {
	if o == nil || IsNil(o.Response) {
		var ret []PublicTemplateLibraryItem
		return ret
	}
	return o.Response
}
...
func (o *GetTemplateLibrary200Response) GetResponseOk() ([]PublicTemplateLibraryItem, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *GetTemplateLibrary200Response) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
// SetResponse gets a reference to the given []PublicTemplateLibraryItem and assigns it to the Response field.
func (o *GetTemplateLibrary200Response) SetResponse(v []PublicTemplateLibraryItem) {
	o.Response = v
}

func (o GetTemplateLibrary200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTemplateLibrary200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTemplateLibrary200Response struct {
	value *GetTemplateLibrary200Response
	isSet bool
}

func (v NullableGetTemplateLibrary200Response) Get() *GetTemplateLibrary200Response {
	return v.value
}

func (v *NullableGetTemplateLibrary200Response) Set(val *GetTemplateLibrary200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTemplateLibrary200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTemplateLibrary200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTemplateLibrary200Response(val *GetTemplateLibrary200Response) *NullableGetTemplateLibrary200Response {
	return &NullableGetTemplateLibrary200Response{value: val, isSet: true}
}

func (v NullableGetTemplateLibrary200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTemplateLibrary200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
