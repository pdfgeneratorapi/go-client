...
// checks if the InlineObject20Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject20Response{}

// InlineObject20Response struct for InlineObject20Response
type InlineObject20Response struct {
	// Unique job id which is also added to the callback request as header PDF-API-Job-Id
	JobId *string `json:"job_id,omitempty"`
}

// NewInlineObject20Response instantiates a new InlineObject20Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInlineObject20Response() *InlineObject20Response {
	this := InlineObject20Response{}
	return &this
}

// NewInlineObject20ResponseWithDefaults instantiates a new InlineObject20Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInlineObject20ResponseWithDefaults() *InlineObject20Response {
	this := InlineObject20Response{}
	return &this
}

// GetJobId returns the JobId field value if set, zero value otherwise.
func (o *InlineObject20Response) GetJobId() string {
...
func (o *InlineObject20Response) GetJobIdOk() (*string, bool) {
	if o == nil || IsNil(o.JobId) {
		return nil, false
	}
	return o.JobId, true
...
func (o *InlineObject20Response) HasJobId() bool {
	if o != nil && !IsNil(o.JobId) {
		return true
	}
...
func (o *InlineObject20Response) SetJobId(v string) {
	o.JobId = &v
}

func (o InlineObject20Response) MarshalJSON() ([]byte, error) {
...
func (o InlineObject20Response) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject20Response struct {
	value *InlineObject20Response
	isSet bool
}

func (v NullableInlineObject20Response) Get() *InlineObject20Response {
	return v.value
}

func (v *NullableInlineObject20Response) Set(val *InlineObject20Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject20Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject20Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject20Response(val *InlineObject20Response) *NullableInlineObject20Response {
	return &NullableInlineObject20Response{value: val, isSet: true}
}

func (v NullableInlineObject20Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject20Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
