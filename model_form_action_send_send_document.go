...
// checks if the FormActionSendSendDocument type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormActionSendSendDocument{}

// FormActionSendSendDocument struct for FormActionSendSendDocument
type FormActionSendSendDocument struct {
	// HTTPS URL where the generated document will be delivered.
	Url string `json:"url"`
	// Optional HTTP headers to include with the delivery request.
	Headers []FormActionSendSendDocumentHeadersInner `json:"headers,omitempty"`
}

type _FormActionSendSendDocument FormActionSendSendDocument
...
func NewFormActionSendSendDocument(url string) *FormActionSendSendDocument {
	this := FormActionSendSendDocument{}
	this.Url = url
	return &this
}
...
func (o *FormActionSendSendDocument) GetHeaders() []FormActionSendSendDocumentHeadersInner {
	if o == nil || IsNil(o.Headers) {
		var ret []FormActionSendSendDocumentHeadersInner
		return ret
	}
	return o.Headers
}
...
// SetHeaders gets a reference to the given []FormActionSendSendDocumentHeadersInner and assigns it to the Headers field.
func (o *FormActionSendSendDocument) SetHeaders(v []FormActionSendSendDocumentHeadersInner) {
	o.Headers = v
}

func (o FormActionSendSendDocument) MarshalJSON() ([]byte, error) {
...
func (o FormActionSendSendDocument) ToMap() (map[string]interface{}, error) {
...
func (o *FormActionSendSendDocument) UnmarshalJSON(data []byte) (err error) {
	...
	varFormActionSendSendDocument := _FormActionSendSendDocument{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormActionSendSendDocument)

	if err != nil {
		return err
	}

	*o = FormActionSendSendDocument(varFormActionSendSendDocument)

	return err
}

type NullableFormActionSendSendDocument struct {
	value *FormActionSendSendDocument
	isSet bool
}

func (v NullableFormActionSendSendDocument) Get() *FormActionSendSendDocument {
	return v.value
}

func (v *NullableFormActionSendSendDocument) Set(val *FormActionSendSendDocument) {
	v.value = val
	v.isSet = true
}

func (v NullableFormActionSendSendDocument) IsSet() bool {
	return v.isSet
}

func (v *NullableFormActionSendSendDocument) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormActionSendSendDocument(val *FormActionSendSendDocument) *NullableFormActionSendSendDocument {
	return &NullableFormActionSendSendDocument{value: val, isSet: true}
}

func (v NullableFormActionSendSendDocument) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormActionSendSendDocument) UnmarshalJSON(src []byte) error {
	v.isSet = true
