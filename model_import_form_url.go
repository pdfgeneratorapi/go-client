...
// checks if the ImportFormUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportFormUrl{}

// ImportFormUrl struct for ImportFormUrl
type ImportFormUrl struct {
	// PDF file from remote URL to import
	FileUrl string `json:"file_url"`
	Form *FormConfigurationNew `json:"form,omitempty"`
}

type _ImportFormUrl ImportFormUrl
...
func (o ImportFormUrl) MarshalJSON() ([]byte, error) {
...
func (o ImportFormUrl) ToMap() (map[string]interface{}, error) {
...
func (o *ImportFormUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varImportFormUrl := _ImportFormUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportFormUrl)

	if err != nil {
		return err
	}

	*o = ImportFormUrl(varImportFormUrl)

	return err
}

type NullableImportFormUrl struct {
	value *ImportFormUrl
	isSet bool
}

func (v NullableImportFormUrl) Get() *ImportFormUrl {
	return v.value
}

func (v *NullableImportFormUrl) Set(val *ImportFormUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableImportFormUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableImportFormUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportFormUrl(val *ImportFormUrl) *NullableImportFormUrl {
	return &NullableImportFormUrl{value: val, isSet: true}
}

func (v NullableImportFormUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportFormUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
