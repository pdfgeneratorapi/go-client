...
func (o *InlineObject10) GetResponse() []string {
...
func (o *InlineObject10) GetResponseOk() ([]string, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject10) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
func (o *InlineObject10) SetResponse(v []string) {
	o.Response = v
}
