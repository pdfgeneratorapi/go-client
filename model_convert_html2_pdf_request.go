...
// checks if the ConvertHTML2PDFRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertHTML2PDFRequest{}

// ConvertHTML2PDFRequest struct for ConvertHTML2PDFRequest
type ConvertHTML2PDFRequest struct {
	// HTML content
...
func (o ConvertHTML2PDFRequest) MarshalJSON() ([]byte, error) {
...
func (o ConvertHTML2PDFRequest) ToMap() (map[string]interface{}, error) {
...
type NullableConvertHTML2PDFRequest struct {
	value *ConvertHTML2PDFRequest
	isSet bool
}

func (v NullableConvertHTML2PDFRequest) Get() *ConvertHTML2PDFRequest {
	return v.value
}

func (v *NullableConvertHTML2PDFRequest) Set(val *ConvertHTML2PDFRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertHTML2PDFRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertHTML2PDFRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertHTML2PDFRequest(val *ConvertHTML2PDFRequest) *NullableConvertHTML2PDFRequest {
	return &NullableConvertHTML2PDFRequest{value: val, isSet: true}
}

func (v NullableConvertHTML2PDFRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertHTML2PDFRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
