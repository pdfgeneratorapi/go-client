...
// checks if the InlineObject21Meta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject21Meta{}

// InlineObject21Meta struct for InlineObject21Meta
type InlineObject21Meta struct {
...
func (o InlineObject21Meta) MarshalJSON() ([]byte, error) {
...
func (o InlineObject21Meta) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject21Meta struct {
	value *InlineObject21Meta
	isSet bool
}

func (v NullableInlineObject21Meta) Get() *InlineObject21Meta {
	return v.value
}

func (v *NullableInlineObject21Meta) Set(val *InlineObject21Meta) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject21Meta) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject21Meta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject21Meta(val *InlineObject21Meta) *NullableInlineObject21Meta {
	return &NullableInlineObject21Meta{value: val, isSet: true}
}

func (v NullableInlineObject21Meta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject21Meta) UnmarshalJSON(src []byte) error {
	v.isSet = true
