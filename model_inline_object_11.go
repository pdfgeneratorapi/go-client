...
func (o *InlineObject11) GetResponse() string {
...
func (o *InlineObject11) GetResponseOk() (*string, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject11) HasResponse() bool {
	if o != nil && !IsNil(o.Response) {
		return true
	}
...
func (o *InlineObject11) SetResponse(v string) {
	o.Response = &v
}
