...
type InlineObject21 struct {
	...
	Meta *InlineObject21Meta `json:"meta,omitempty"`
}
...
func (o *InlineObject21) GetResponse() string {
...
func (o *InlineObject21) GetResponseOk() (*string, bool) {
	if o == nil || IsNil(o.Response) {
		return nil, false
	}
...
func (o *InlineObject21) SetResponse(v string) {
	o.Response = &v
}
...
// SetMeta gets a reference to the given InlineObject21Meta and assigns it to the Meta field.
