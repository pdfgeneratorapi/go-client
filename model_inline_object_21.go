...
func (o *InlineObject21) GetMessage() string {
...
func (o *InlineObject21) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject21) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject21) SetMessage(v string) {
	o.Message = &v
}
