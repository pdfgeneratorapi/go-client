...
func (o *InlineObject28) GetMessage() string {
...
func (o *InlineObject28) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *InlineObject28) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *InlineObject28) SetMessage(v string) {
	o.Message = &v
}
