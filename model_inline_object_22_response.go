...
// checks if the InlineObject22Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject22Response{}

// InlineObject22Response struct for InlineObject22Response
type InlineObject22Response struct {
...
func (o InlineObject22Response) MarshalJSON() ([]byte, error) {
...
func (o InlineObject22Response) ToMap() (map[string]interface{}, error) {
...
type NullableInlineObject22Response struct {
	value *InlineObject22Response
	isSet bool
}

func (v NullableInlineObject22Response) Get() *InlineObject22Response {
	return v.value
}

func (v *NullableInlineObject22Response) Set(val *InlineObject22Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject22Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject22Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject22Response(val *InlineObject22Response) *NullableInlineObject22Response {
	return &NullableInlineObject22Response{value: val, isSet: true}
}

func (v NullableInlineObject22Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject22Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
