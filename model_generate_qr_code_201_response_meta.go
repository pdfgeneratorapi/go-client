...
// checks if the GenerateQRCode201ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateQRCode201ResponseMeta{}

// GenerateQRCode201ResponseMeta struct for GenerateQRCode201ResponseMeta
type GenerateQRCode201ResponseMeta struct {
	// Response encoding
...
// NewGenerateQRCode201ResponseMeta instantiates a new GenerateQRCode201ResponseMeta object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGenerateQRCode201ResponseMeta() *GenerateQRCode201ResponseMeta {
	this := GenerateQRCode201ResponseMeta{}
	return &this
}

// NewGenerateQRCode201ResponseMetaWithDefaults instantiates a new GenerateQRCode201ResponseMeta object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGenerateQRCode201ResponseMetaWithDefaults() *GenerateQRCode201ResponseMeta {
	this := GenerateQRCode201ResponseMeta{}
	return &this
}

// GetEncoding returns the Encoding field value if set, zero value otherwise.
func (o *GenerateQRCode201ResponseMeta) GetEncoding() string {
...
func (o *GenerateQRCode201ResponseMeta) GetEncodingOk() (*string, bool) {
	if o == nil || IsNil(o.Encoding) {
		return nil, false
	}
...
func (o *GenerateQRCode201ResponseMeta) HasEncoding() bool {
	if o != nil && !IsNil(o.Encoding) {
		return true
	}
...
func (o *GenerateQRCode201ResponseMeta) SetEncoding(v string) {
	o.Encoding = &v
}

// GetContentType returns the ContentType field value if set, zero value otherwise.
func (o *GenerateQRCode201ResponseMeta) GetContentType() string {
...
// and a boolean to check if the value has been set.
func (o *GenerateQRCode201ResponseMeta) GetContentTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ContentType) {
		return nil, false
	}
...
func (o *GenerateQRCode201ResponseMeta) HasContentType() bool {
	if o != nil && !IsNil(o.ContentType) {
		return true
	}
...
func (o *GenerateQRCode201ResponseMeta) SetContentType(v string) {
	o.ContentType = &v
}

func (o GenerateQRCode201ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GenerateQRCode201ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGenerateQRCode201ResponseMeta struct {
	value *GenerateQRCode201ResponseMeta
	isSet bool
}

func (v NullableGenerateQRCode201ResponseMeta) Get() *GenerateQRCode201ResponseMeta {
	return v.value
}

func (v *NullableGenerateQRCode201ResponseMeta) Set(val *GenerateQRCode201ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateQRCode201ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateQRCode201ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateQRCode201ResponseMeta(val *GenerateQRCode201ResponseMeta) *NullableGenerateQRCode201ResponseMeta {
	return &NullableGenerateQRCode201ResponseMeta{value: val, isSet: true}
}

func (v NullableGenerateQRCode201ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateQRCode201ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
